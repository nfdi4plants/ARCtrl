import { append as append_1, delay, tryItem, length as length_1, isEmpty, iterate, fold, tryPick, maxBy, initialize, choose, map, indexed } from "../../fable_modules/fable-library-js.4.22.0/Seq.js";
import { defaultArg, map as map_1 } from "../../fable_modules/fable-library-js.4.22.0/Option.js";
import { tryFind, ofSeq } from "../../fable_modules/fable-library-js.4.22.0/Map.js";
import { arrayHash, equalArrays, equals, comparePrimitives } from "../../fable_modules/fable-library-js.4.22.0/Util.js";
import { RowBuilder_get_Empty, RowBuilder__Combine_19F30600, RowBuilder_$ctor } from "../../fable_modules/FsSpreadsheet.6.3.0-alpha.4/DSL/RowBuilder.fs.js";
import { CellBuilder_$ctor, CellBuilder__AsCellElement_6F87C2ED } from "../../fable_modules/FsSpreadsheet.6.3.0-alpha.4/DSL/CellBuilder.fs.js";
import { Messages_format, SheetEntity$1_some_2B595 } from "../../fable_modules/FsSpreadsheet.6.3.0-alpha.4/DSL/Types.fs.js";
import { DataType } from "../../fable_modules/FsSpreadsheet.6.3.0-alpha.4/Cells/FsCell.fs.js";
import { map as map_2, initialize as initialize_1, exists, find, cons, append, empty, singleton } from "../../fable_modules/fable-library-js.4.22.0/List.js";
import { ColumnIndex, RowElement } from "../../fable_modules/FsSpreadsheet.6.3.0-alpha.4/DSL/Types.fs.js";
...
import { record_type, list_type, class_type, tuple_type, int32_type, string_type } from "../../fable_modules/fable-library-js.4.22.0/Reflection.js";
...
export function SparseRowModule_writeToSheet(rowI, row, sheet) {
    const fsRow = sheet.RowWithRange(FsRangeAddress_$ctor_7E77A4A0(FsAddress_$ctor_Z37302880(rowI, 1), FsAddress_$ctor_Z37302880(rowI, 1)), true);
    iterate((tupledArg) => {
        const v = tupledArg[1];
        if (v.trim() !== "") {
                    ...
                    switch (matchResult) {
                        ...
                        default: {
                            ...
                            switch (matchResult_1) {
                                ...
                                default:
                                    return [undefined, lineNumber_1, remarks, matrix];
                            }
                        }
                    }
                }
