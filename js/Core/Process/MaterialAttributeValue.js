...
import { unwrap, defaultArg, bind, map } from "../../fable_modules/fable-library-js.4.22.0/Option.js";
...
export function MaterialAttributeValue__SetCategory_ZDED3A0F(this$, c) {
    let matchValue;
    return new MaterialAttributeValue(this$.ID, (matchValue = this$.Category, (matchValue == null) ? MaterialAttribute_create_A220A8A(undefined, c) : MaterialAttribute__SetCategory_ZDED3A0F(matchValue, c)), this$.Value, this$.Unit);
}
...
export function MaterialAttributeValue_createAsPV(alternateName, measurementMethod, description, category, value, unit) {
    return MaterialAttributeValue_create_ZE1D108D(undefined, unwrap(map((c) => MaterialAttribute_create_A220A8A(undefined, c), category)), unwrap(value), unwrap(unit));
}
