...
export function FactorValue__SetCategory_ZDED3A0F(this$, c) {
    let matchValue, p;
    return new FactorValue(this$.ID, (matchValue = this$.Category, (matchValue == null) ? Factor.create(undefined, c) : ((p = matchValue, p.SetCategory(c)))), this$.Value, this$.Unit);
}
...
export function FactorValue_createAsPV(alternateName, measurementMethod, description, category, value, unit) {
    return FactorValue_create_30BDC49(undefined, unwrap(map((c) => Factor.create(undefined, c), category)), unwrap(value), unwrap(unit));
}
