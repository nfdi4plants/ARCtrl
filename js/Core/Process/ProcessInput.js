...
export function ProcessInput_createSource_Z5E00540E(name, characteristics) {
    return new ProcessInput(0, [Source_create_Z5CA08497(undefined, name, unwrap(characteristics))]);
}

export function ProcessInput_createSample_Z598187B7(name, characteristics, factors, derivesFrom) {
    return new ProcessInput(1, [Sample_create_62424AD2(undefined, name, unwrap(characteristics), unwrap(factors), unwrap(derivesFrom))]);
}

export function ProcessInput_createMaterial_4452CB4C(name, characteristics, derivesFrom) {
    return new ProcessInput(3, [Material_create_Z66909A6D(undefined, name, undefined, unwrap(characteristics), unwrap(derivesFrom))]);
}

export function ProcessInput_createImageFile_Z721C83C5(name) {
    return new ProcessInput(2, [Data.create(undefined, name, new DataFile(2, []))]);
}

export function ProcessInput_createRawData_Z721C83C5(name) {
    return new ProcessInput(2, [Data.create(undefined, name, new DataFile(0, []))]);
}

export function ProcessInput_createDerivedData_Z721C83C5(name) {
    return new ProcessInput(2, [Data.create(undefined, name, new DataFile(1, []))]);
}
