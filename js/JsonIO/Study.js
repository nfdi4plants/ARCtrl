...
import { ISAJson_encoder, ISAJson_decoder, ROCrate_encoder, ROCrate_decoder, encoderCompressed, decoderCompressed, encoder, decoder as decoder_1 } from "../Json/Study.js";
...
export function ARCtrl_ArcStudy__ArcStudy_toROCrateJsonString_Static_3BA23086(assays, spaces) {
    return (obj) => {
        const value = ROCrate_encoder(assays, obj);
        return toString(defaultSpaces(spaces), value);
    };
}
...
export function ARCtrl_ArcStudy__ArcStudy_toISAJsonString_Static_Z3FD920F1(assays, spaces, useIDReferencing) {
    ...
    return (obj) => {
        const value = ISAJson_encoder(idMap, assays, obj);
        return toString(defaultSpaces(spaces), value);
    };
}
