...
import { Remark_toTuple_Z2023CF4E, Comment$_$reflection } from "../../ISA/JsonTypes/Comment.js";
import { head, tail, ofSeq, append, reverse, cons, iterate, isEmpty, empty, map, ofArray } from "../../../fable_modules/fable-library.4.1.4/List.js";
import { Remark_wrapRemark, Comment_toString, Comment_fromString } from "../Comment.js";
import { SparseRowModule_writeToSheet, SparseRowModule_fromFsRow, SparseRowModule_fromValues, SparseRowModule_tryGetValueAt, SparseTable_ToRows_584133C0, SparseTable_FromRows_Z5579EC29, SparseTable, SparseTable_Create_Z2192E64B, SparseTable__TryGetValueDefault_5BAE6133 } from "../SparseTable.js";
...
export function InvestigationInfo_FromSparseTable_Z15A4F148(matrix) {
...
export function InvestigationInfo_ToSparseTable_Z1FC82C0(investigation) {
...
export function InvestigationInfo_fromRows(lineNumber, rows) {
    ...
    return [tupledArg[0], tupledArg[1], tupledArg[2], InvestigationInfo_FromSparseTable_Z15A4F148(tupledArg[3])];
}

export function InvestigationInfo_toRows_Z1FC82C0(investigation) {
...
export function fromFsWorkbook(doc) {
    let arg;
    try {
        return fromRows(map_1(SparseRowModule_fromFsRow, (arg = head(doc.GetWorksheets()), FsWorksheet.getRows(arg))));
    }
    catch (err) {
