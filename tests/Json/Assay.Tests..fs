...
let private test_isa =
    ...
    testList "isa" [
        createBaseJsonTests
            ...
            ArcAssay.toISAJsonString
            ArcAssay.fromISAJsonString
        //ftestCase "ReaderSuccess" (fun () -> 
        //    let readingSuccess = 
        //        try 
        //            ArcAssay.fromISAJsonString Assay.assay |> ignore
        //            Result.Ok "DidRun"
        //        with
        ...
        //    let a = ArcAssay.fromISAJsonString Assay.assay
        //    let writingSuccess = 
        //        try 
        //            ArcAssay.toISAJsonString () a |> ignore
        //            Result.Ok "DidRun"
        //        with
        ...
        //    let a = ArcAssay.fromISAJsonString Assay.assay
        //    let s = ArcAssay.toISAJsonString () a
        ...
        //    let o = 
        //        ArcAssay.fromISAJsonString Assay.assay
        //        |> ArcAssay.toISAJsonString ()
        //    let expected = Assay.assay
        //    let actual = o
        //    Expect.stringEqual actual expected "Written assay file does not match read assay file"
        //)
    ]
