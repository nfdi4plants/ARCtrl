...
let private test_coreEmpty =
    let json = """{"Identifier":"My Fancy Stundy"}"""
    createBaseJsonTests
        "core-empty"
        create_empty
...
let private test_compressedEmpty =
    let json = """{"cellTable":[],"oaTable":[],"stringTable":[],"object":{"Identifier":"My Fancy Stundy"}}"""
    createBaseJsonTests
        "compressed-empty"
        create_empty
...
let private test_isaEmpty =
    let json = """{"filename":"assays/My Fancy Stundy/isa.assay.xlsx","identifier":"My Fancy Stundy"}"""
    createBaseJsonTests
        "isa-empty"
        create_empty
...
let private test_core =
    let json = """{"Identifier":"My Study","Title":"My Title","Description":"My Description","SubmissionDate":"My Submission Date","PublicReleaseDate":"My Release Date","Publications":[{"doi":"any-nice-doi-42"}],"Contacts":[{"firstName":"Kevin","lastName":"Frey","phone":"023382093810"}],"StudyDesignDescriptors":[{},{}],"Tables":[{"name":"New Table","header":[{"headertype":"Input","values":["Source Name"]},{"headertype":"Component","values":[{"annotationValue":"instrument model","termSource":"MS","termAccession":"MS:424242"}]},{"headertype":"Output","values":["Sample Name"]}],"values":[[[0,0],{"celltype":"FreeText","values":["Input 1"]}],[[0,1],{"celltype":"FreeText","values":["Input 2"]}],[[1,0],{"celltype":"Term","values":[{"annotationValue":"SCIEX instrument model"}]}],[[1,1],{"celltype":"Term","values":[{"annotationValue":"SCIEX instrument model"}]}],[[2,0],{"celltype":"FreeText","values":["Output 1"]}],[[2,1],{"celltype":"FreeText","values":["Output 2"]}]]},{"name":"Table 2"}],"RegisteredAssayIdentifiers":["Assay 1","Assay 2"],"Comments":[{"name":"Hello","value":"World"}]}"""
    createBaseJsonTests
        "core"
        create_filled
        ArcStudy.toJsonString
...
let private test_compressed =
    let json = """{"cellTable":[{"t":3,"v":[2]},{"t":3,"v":[4]},{"t":5,"v":[0]},{"t":3,"v":[6]},{"t":3,"v":[7]}],"oaTable":[{"a":8}],"stringTable":["New Table","Table 2","Input 1","FreeText","Input 2","Term","Output 1","Output 2","SCIEX instrument model"],"object":{"Identifier":"My Study","Title":"My Title","Description":"My Description","SubmissionDate":"My Submission Date","PublicReleaseDate":"My Release Date","Publications":[{"doi":"any-nice-doi-42"}],"Contacts":[{"firstName":"Kevin","lastName":"Frey","phone":"023382093810"}],"StudyDesignDescriptors":[{},{}],"Tables":[{"n":0,"h":[{"headertype":"Input","values":["Source Name"]},{"headertype":"Component","values":[{"annotationValue":"instrument model","termSource":"MS","termAccession":"MS:424242"}]},{"headertype":"Output","values":["Sample Name"]}],"c":[[0,1],[2,2],[3,4]]},{"n":1}],"RegisteredAssayIdentifiers":["Assay 1","Assay 2"],"Comments":[{"name":"Hello","value":"World"}]}}"""
    createBaseJsonTests
        "compressed"
        create_filled
        ArcStudy.toCompressedJsonString
