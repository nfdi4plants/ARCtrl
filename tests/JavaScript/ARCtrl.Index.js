...
import { OntologyAnnotation, ArcAssay, ArcInvestigation, ArcTable, JsonController } from './ARCtrl/index.js'
...
describe('Auto Generated Index', function () {
    it('OntologyAnnotation', function () {
        let actual = OntologyAnnotation.create("My OA")
    ...
    it('JsonController', function () {
      let actual = new ArcInvestigation("My Investigation", "Super Awesome Experiment")
      let json = JsonController.Investigation.toJsonString(0)(actual)
      const expected = '{"Identifier":"My Investigation","Title":"Super Awesome Experiment"}'
      equal(json, expected, "json conversion")
    });
});