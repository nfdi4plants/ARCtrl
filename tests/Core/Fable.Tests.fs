...
let private tests_EmptyObjectCreation = 
    testList "EmptyObjectCreationTests" [
        ...
        testCase "MakeEmptyInvestigation" (fun () ->
            let i = ArcInvestigation.make "My Identifier" None None None None (ResizeArray()) (ResizeArray()) (ResizeArray()) (ResizeArray()) (ResizeArray()) (ResizeArray()) (ResizeArray()) (ResizeArray()) (ResizeArray()) (ResizeArray())
