...
let tests_profile_object_is_valid = testList "constructed properties" [
    testList "mandatory properties" [
        testCase "Id" <| fun _ -> Expect.LDObjectHasId "scholarlyarticle_mandatory_properties_id" mandatory_properties
        testCase "SchemaType" <| fun _ -> Expect.LDObjectHasType "schema.org/ScholarlyArticle" mandatory_properties
    ...
    testList "all properties" [
        ...
        testCase "headline" <| fun _ -> Expect.LDObjectHasDynamicProperty "headline" "headline" all_properties
        testCase "identifier" <| fun _ -> Expect.LDObjectHasDynamicProperty "identifier" "identifier" all_properties
        testCase "author" <| fun _ -> Expect.LDObjectHasDynamicProperty "author" "author" all_properties
        testCase "url" <| fun _ -> Expect.LDObjectHasDynamicProperty "url" "url" all_properties
        testCase "creativeWorkStatus" <| fun _ -> Expect.LDObjectHasDynamicProperty "creativeWorkStatus" "creativeWorkStatus" all_properties
