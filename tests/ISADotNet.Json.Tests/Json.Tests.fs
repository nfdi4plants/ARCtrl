...
let testEncode =
    ...
    testList "Encode" [
        ...
        testCase "tryGetPropertyValueSequence" (fun () ->
            ...
            let comments = [ISADotNet.Comment.fromString "k1" "v1"; ISADotNet.Comment.fromString "k2" "vv"]
            let oa = ISADotNet.OntologyAnnotation.fromStringWithComments "MyAnnotation" "ABC:123" "ABC" comments
