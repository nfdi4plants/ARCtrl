...
module BII_I_1 =
    ...
    let fullInvestigation =
        ...
        row71.[2].Value <- $"assays/{Assay.Proteome.assayIdentifier}/isa.assay.xlsx"
        row71.[3].Value <- $"assays/{Assay.Metabolome.assayIdentifier}/isa.assay.xlsx"
        row71.[4].Value <- $"assays/{Assay.Transcriptome.assayIdentifier}/isa.assay.xlsx"
        let row72 = ws.Row(72)
        ...
        row102.[2].Value <- Study.BII_S_2.studyIdentifier
        ...
        row107.[2].Value <- $"studies/{Study.BII_S_2.studyIdentifier}/isa.study.xlsx"
        ...
        row135.[2].Value <- $"assays/{Assay.Transcriptome.assayIdentifier}/isa.assay.xlsx"
