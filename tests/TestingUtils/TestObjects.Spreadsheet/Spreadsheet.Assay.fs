...
module Metabolome =
    ...
    let assayMetadata = 
        ...
        let row2 = ws.Row(2)
        row2.[1].Value <- "Assay Measurement Type"
        row2.[2].Value <- "metabolite profiling"
        let row3 = ws.Row(3)
        row3.[1].Value <- "Assay Measurement Type Term Accession Number"
        row3.[2].Value <- "http://purl.obolibrary.org/obo/OBI_0000366"
        let row4 = ws.Row(4)
        row4.[1].Value <- "Assay Measurement Type Term Source REF"
        row4.[2].Value <- "OBI"
        let row5 = ws.Row(5)
...
module Transcriptome = 
    ...
    let assayMetadata = 
        ...
        let row2 = ws.Row(2)
        row2.[1].Value <- "Assay Measurement Type"
        row2.[2].Value <- "transcription profiling"
        let row3 = ws.Row(3)
        row3.[1].Value <- "Assay Measurement Type Term Accession Number"
        row3.[2].Value <- "424"
        let row4 = ws.Row(4)
        ...
        let row5 = ws.Row(5)
        row5.[1].Value <- "Assay Technology Type"
        row5.[2].Value <- "DNA microarray"
        let row6 = ws.Row(6)
        row6.[1].Value <- "Assay Technology Type Term Accession Number"
        row6.[2].Value <- "http://purl.obolibrary.org/obo/OBI_0400148"
        let row7 = ws.Row(7)
        row7.[1].Value <- "Assay Technology Type Term Source REF"
        row7.[2].Value <- "OBI"
        let row8 = ws.Row(8)
        row8.[1].Value <- "Assay Technology Platform"
        row8.[2].Value <- "Affymetrix"
        let row9 = ws.Row(9)
        row9.[1].Value <- "Assay File Name"
        row9.[2].Value <- $"assays/{assayIdentifier}/isa.assay.xlsx"
        let row10 = ws.Row(10)
