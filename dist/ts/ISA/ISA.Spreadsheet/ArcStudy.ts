...
import { iterate, isEmpty, choose, map, singleton, append, delay, iterateIndexed } from "../../fable_modules/fable-library-ts/Seq.js";
...
export function toMetadataSheet(study: ArcStudy): FsWorksheet {
    ...
    }, delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => StudyInfo_toRows_1B3D5E9B(study)))));
    return sheet;
}
