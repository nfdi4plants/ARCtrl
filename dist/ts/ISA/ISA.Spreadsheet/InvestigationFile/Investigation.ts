...
import { head, tail, isEmpty, ofSeq, append, toArray, reverse, cons, empty, map, ofArray, FSharpList } from "../../../fable_modules/fable-library-ts/List.js";
...
import { SparseRowModule_writeToSheet, SparseRowModule_fromFsRow, SparseRowModule_fromValues, SparseRowModule_tryGetValueAt, SparseTable_ToRows_6A3D4534, SparseTable_FromRows_Z5579EC29, SparseTable_Create_Z2192E64B, SparseTable, SparseTable__TryGetValueDefault_5BAE6133 } from "../SparseTable.js";
...
import { iterateIndexed, head as head_1, map as map_1, toList, collect, singleton, append as append_1, delay } from "../../../fable_modules/fable-library-ts/Seq.js";
...
export function InvestigationInfo_FromSparseTable_651559CC(matrix: SparseTable): InvestigationInfo {
...
export function InvestigationInfo_ToSparseTable_Z4D87C88C(investigation: ArcInvestigation): SparseTable {
    ...
    if (!(investigation.Comments.length === 0)) {
        const array: Comment$[] = investigation.Comments;
...
export function InvestigationInfo_fromRows(lineNumber: int32, rows: IEnumerator<Iterable<[int32, string]>>): [Option<string>, int32, FSharpList<Remark>, InvestigationInfo] {
    ...
    return [tupledArg[0], tupledArg[1], tupledArg[2], InvestigationInfo_FromSparseTable_651559CC(tupledArg[3])] as [Option<string>, int32, FSharpList<Remark>, InvestigationInfo];
}

export function InvestigationInfo_toRows_Z4D87C88C(investigation: ArcInvestigation): Iterable<Iterable<[int32, string]>> {
...
export function fromParts(investigationInfo: InvestigationInfo, ontologySourceReference: FSharpList<OntologySourceReference>, publications: FSharpList<Publication>, contacts: FSharpList<Person>, studies: FSharpList<ArcStudy>, remarks: FSharpList<Remark>): ArcInvestigation {
    ...
    const arg_5: OntologySourceReference[] = toArray<OntologySourceReference>(ontologySourceReference);
    const arg_6: Publication[] = toArray<Publication>(publications);
    const arg_7: Person[] = toArray<Person>(contacts);
    const arg_8: ArcStudy[] = Array.from(studies);
    const arg_9: Comment$[] = toArray<Comment$>(investigationInfo.Comments);
    const arg_10: Remark[] = toArray<Remark>(remarks);
...
export function toRows(investigation: ArcInvestigation): Iterable<Iterable<[int32, string]>> {
    ...
    return (remarks = ofArray<Remark>(investigation.Remarks), (rows = delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["ONTOLOGY SOURCE REFERENCE"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_1(ofArray<OntologySourceReference>(investigation.OntologySourceReferences)), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["INVESTIGATION"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(InvestigationInfo_toRows_Z4D87C88C(investigation), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["INVESTIGATION PUBLICATIONS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_2("Investigation Publication", ofArray<Publication>(investigation.Publications)), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["INVESTIGATION CONTACTS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_3("Investigation Person", ofArray<Person>(investigation.Contacts)), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => collect<ArcStudy, Iterable<Iterable<[int32, string]>>, Iterable<[int32, string]>>((study: ArcStudy): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => toRows_4(study))), ofSeq<ArcStudy>(investigation.Studies))))))))))))))))))), (() => {
        try {
            const rm: FSharpMap<int32, string> = ofList<int32, string>(map<Remark, [int32, string]>((arg: Remark): [int32, string] => Remark.toTuple(arg), remarks), {
...
export function fromFsWorkbook(doc: FsWorkbook): ArcInvestigation {
    let arg: FsWorksheet;
    try {
        return fromRows(map_1<FsRow, Iterable<[int32, string]>>(SparseRowModule_fromFsRow, (arg = head_1<FsWorksheet>(doc.GetWorksheets()), FsWorksheet.getRows(arg))));
    }
    catch (err: any) {
