...
export function ActivePattern_$007CComponent$007C_$007C(cells: FSharpList<FsCell>): Option<CompositeHeader_$union> {
    const activePatternResult: Option<CompositeHeader_$union> = ActivePattern_$007CTerm$007C_$007C(tryParseComponentColumnHeader, CompositeHeader_Component, cells);
    if (activePatternResult != null) {
        const r: CompositeHeader_$union = value(activePatternResult);
        return r;
    }
    ...
    if (activePatternResult != null) {
        ...
        if (activePatternResult_1 != null) {
            ...
            if (activePatternResult_2 != null) {
                ...
                const activePatternResult_3: Option<CompositeHeader_$union> = ActivePattern_$007CComponent$007C_$007C(cells);
                if (activePatternResult_3 != null) {
                    const c_1: CompositeHeader_$union = value(activePatternResult_3);
                    return c_1;
                }
                else {
                    const activePatternResult_4: Option<CompositeHeader_$union> = ActivePattern_$007CInput$007C_$007C(cells);
                    if (activePatternResult_4 != null) {
                        const i: CompositeHeader_$union = value(activePatternResult_4);
                        return i;
                    }
                    else {
                        const activePatternResult_5: Option<CompositeHeader_$union> = ActivePattern_$007COutput$007C_$007C(cells);
                        if (activePatternResult_5 != null) {
                            const o: CompositeHeader_$union = value(activePatternResult_5);
                            return o;
                        }
                        else {
                            const activePatternResult_6: Option<CompositeHeader_$union> = ActivePattern_$007CProtocolHeader$007C_$007C(cells);
                            if (activePatternResult_6 != null) {
                                const ph: CompositeHeader_$union = value(activePatternResult_6);
                                return ph;
                            }
                            else {
                                const activePatternResult_7: Option<CompositeHeader_$union> = ActivePattern_$007CFreeText$007C_$007C(cells);
                                if (activePatternResult_7 != null) {
                                    const ft: CompositeHeader_$union = value(activePatternResult_7);
                                    return ft;
                                }
                                else {
