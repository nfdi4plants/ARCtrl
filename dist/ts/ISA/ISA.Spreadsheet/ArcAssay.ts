...
import { iterate, isEmpty as isEmpty_1, choose, tryHead, head, exists, map, singleton, append, delay, iterateIndexed } from "../../fable_modules/fable-library-ts/Seq.js";
...
import { empty, isEmpty, toArray, FSharpList, ofArray, singleton as singleton_1 } from "../../fable_modules/fable-library-ts/List.js";
...
export function toMetadataSheet(assay: ArcAssay): FsWorksheet {
    ...
    }, (assay_1 = assay, delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["ASSAY"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append<Iterable<[int32, string]>>(toRows_1("Assay", singleton_1(assay_1)), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["ASSAY PERFORMERS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => toRows_2("Assay Person", ofArray<Person>(assay_1.Performers)))))))))));
    return sheet;
}
            ...
            switch (matchResult) {
                ...
                default: {
                    ...
                    switch (matchResult_1) {
                        ...
                        default: {
                            const arg: Person[] = toArray<Person>(contacts_2!);
...
export function fromFsWorkbook(doc: FsWorkbook): ArcAssay {
    ...
    const sheets: Iterable<ArcTable> = choose<FsWorksheet, ArcTable>(tryFromFsWorksheet, doc.GetWorksheets());
    if (isEmpty_1<ArcTable>(sheets)) {
