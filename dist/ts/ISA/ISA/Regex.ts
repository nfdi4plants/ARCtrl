 ...
 */
export function ActivePatterns_$007CReferenceColumnHeader$007C_$007C(input: string): Option<{ Annotation: string }> {
    const activePatternResult: Option<any> = ActivePatterns_$007CRegex$007C_$007C("(Term Source REF|Term Accession Number)\\s\\((?<id>.*)\\)", input);
 ...
 */
export function ActivePatterns_$007CComponentColumnHeader$007C_$007C(input: string): Option<string> {
    const activePatternResult: Option<{ TermColumnType: string, TermName: string }> = ActivePatterns_$007CTermColumn$007C_$007C(input);
    if (activePatternResult != null) {
        const r: { TermColumnType: string, TermName: string } = value_1(activePatternResult);
        const matchValue: string = r.TermColumnType;
...
export function tryParseReferenceColumnHeader(str: string): Option<{ Annotation: string }> {
    const matchValue: string = str.trim();
    const activePatternResult: Option<{ Annotation: string }> = ActivePatterns_$007CReferenceColumnHeader$007C_$007C(matchValue);
    if (activePatternResult != null) {
        const v: { Annotation: string } = value_1(activePatternResult);
        return v;
    }
    else {
        return void 0;
 ...
 */
export function tryParseComponentColumnHeader(input: string): Option<string> {
    const activePatternResult: Option<string> = ActivePatterns_$007CComponentColumnHeader$007C_$007C(input);
    if (activePatternResult != null) {
        const r: string = value_1(activePatternResult);
        return r;
    }
