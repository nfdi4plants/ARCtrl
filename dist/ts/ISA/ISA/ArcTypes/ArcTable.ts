...
import { ProtocolParameter_create_Z6C54B221, ProtocolParameter } from "../JsonTypes/ProtocolParameter.js";
...
import { Component_create_61502994, Component } from "../JsonTypes/Component.js";
    ...
    static fromProtocol(p: Protocol): ArcTable {
        ...
        try {
            while (enumerator["System.Collections.IEnumerator.MoveNext"]()) {
                ...
                t.AddColumn(CompositeHeader_Parameter(value_9(pp.ParameterName)), void 0, ARCtrl_ISA_ProtocolParameter__ProtocolParameter_TryGetColumnIndex(pp));
            }
        }
        finally {
        ...
        try {
            while (enumerator_1["System.Collections.IEnumerator.MoveNext"]()) {
                ...
                t.AddColumn(CompositeHeader_Parameter(value_9(c.ComponentType)), v_1, ARCtrl_ISA_Component__Component_TryGetColumnIndex(c));
            }
        }
        finally {
