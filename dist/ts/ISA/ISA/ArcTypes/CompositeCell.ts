...
export class CompositeCell<Tag extends keyof CompositeCell_$cases> extends Union<Tag, CompositeCell_$cases[Tag][0]> {
    ...
    ToUnitizedCell(): CompositeCell_$union {
        ...
        switch (this$.tag) {
            case /* FreeText */ 1: {
                const text: string = this$.fields[0];
                return CompositeCell_Unitized("", OntologyAnnotation.create(void 0, AnnotationValue_Text(text)));
            }
            case /* Term */ 0:
                return CompositeCell_Unitized("", this$.fields[0]);
            default:
                return this$;
        }
    }
    ToTermCell(): CompositeCell_$union {
        ...
        switch (this$.tag) {
            case /* Unitized */ 2:
                return CompositeCell_Term(this$.fields[1]);
            case /* FreeText */ 1: {
                const text: string = this$.fields[0];
                return CompositeCell_Term(OntologyAnnotation.create(void 0, AnnotationValue_Text(text)));
            }
            default:
                return this$;
        }
    ...
    ToFreeTextCell(): CompositeCell_$union {
        ...
        switch (this$.tag) {
            case /* Term */ 0: {
                const term: OntologyAnnotation = this$.fields[0];
                return CompositeCell_FreeText(term.NameText);
            }
            case /* Unitized */ 2: {
                const v: string = this$.fields[0];
                const unit: OntologyAnnotation = this$.fields[1];
                return CompositeCell_FreeText(unit.NameText);
            }
            default:
                return this$;
        }
    ...
    static createTermFromString(name?: string, tsr?: string, tan?: string): CompositeCell_$union {
        return CompositeCell_Term(OntologyAnnotation.fromString(name, tsr, tan));
    }
    static createUnitized(value: string, oa?: OntologyAnnotation): CompositeCell_$union {
        return CompositeCell_Unitized(value, defaultArg(oa, OntologyAnnotation.empty));
    }
    static createUnitizedFromString(value: string, name?: string, tsr?: string, tan?: string): CompositeCell_$union {
        const tupledArg = [value, OntologyAnnotation.fromString(name, tsr, tan)] as [string, OntologyAnnotation];
    ...
    toString(): string {
        ...
        switch (this$.tag) {
            case /* FreeText */ 1:
                return this$.fields[0];
            case /* Unitized */ 2: {
                const oa_1: OntologyAnnotation = this$.fields[1];
                return `${this$.fields[0]} ${oa_1.NameText}`;
            }
            default: {
                const oa: OntologyAnnotation = this$.fields[0];
                return `Term${oa.NameText}`;
            }
        }
    }
}
