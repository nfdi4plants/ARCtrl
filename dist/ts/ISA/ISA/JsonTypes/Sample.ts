...
export function Sample_create_E50ED22(Id?: string, Name?: string, Characteristics?: FSharpList<MaterialAttributeValue>, FactorValues?: FSharpList<FactorValue>, DerivesFrom?: FSharpList<Source>): Sample {
...
export function Sample_getCharacteristicUnits_Z29207F1E(s: Sample): FSharpList<OntologyAnnotation> {
...
export function Sample_getFactorUnits_Z29207F1E(s: Sample): FSharpList<OntologyAnnotation> {
...
export function Sample_getUnits_Z29207F1E(s: Sample): FSharpList<OntologyAnnotation> {
    return append<OntologyAnnotation>(Sample_getCharacteristicUnits_Z29207F1E(s), Sample_getFactorUnits_Z29207F1E(s));
}
