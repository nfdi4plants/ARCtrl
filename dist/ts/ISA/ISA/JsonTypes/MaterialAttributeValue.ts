...
import { MaterialAttribute__SetCategory_Z4C0FE73C, MaterialAttribute_create_Z6C54B221, MaterialAttribute__MapCategory_Z69DD836A, MaterialAttribute__get_TryNameText, MaterialAttribute_$reflection, MaterialAttribute, MaterialAttribute__get_NameText } from "./MaterialAttribute.js";
...
export function MaterialAttributeValue_create_7F714043(Id?: string, Category?: MaterialAttribute, Value?: Value_$union, Unit?: OntologyAnnotation): MaterialAttributeValue {
...
export function MaterialAttributeValue__MapCategory_Z69DD836A(this$: MaterialAttributeValue, f: ((arg0: OntologyAnnotation) => OntologyAnnotation)): MaterialAttributeValue {
    return new MaterialAttributeValue(this$.ID, map<MaterialAttribute, MaterialAttribute>((p: MaterialAttribute): MaterialAttribute => MaterialAttribute__MapCategory_Z69DD836A(p, f), this$.Category), this$.Value, this$.Unit);
}

export function MaterialAttributeValue__SetCategory_Z4C0FE73C(this$: MaterialAttributeValue, c: OntologyAnnotation): MaterialAttributeValue {
    let matchValue: Option<MaterialAttribute>;
    return new MaterialAttributeValue(this$.ID, (matchValue = this$.Category, (matchValue == null) ? MaterialAttribute_create_Z6C54B221(void 0, c) : MaterialAttribute__SetCategory_Z4C0FE73C(value_3(matchValue), c)), this$.Value, this$.Unit);
}

/**
 * Returns the name of the characteristic value as string if it exists
 */
export function MaterialAttributeValue_tryGetNameText_43A5B238(mv: MaterialAttributeValue): Option<string> {
 ...
 */
export function MaterialAttributeValue_getNameAsString_43A5B238(mv: MaterialAttributeValue): Option<string> {
    return MaterialAttributeValue__get_TryNameText(mv);
}
