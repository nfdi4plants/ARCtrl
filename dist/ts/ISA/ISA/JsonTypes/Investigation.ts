...
import { Study_update_7312BC8B, Study_$reflection, Study } from "./Study.js";
...
export function Investigation_create_4AD66BBE(Id?: string, FileName?: string, Identifier?: string, Title?: string, Description?: string, SubmissionDate?: string, PublicReleaseDate?: string, OntologySourceReferences?: FSharpList<OntologySourceReference>, Publications?: FSharpList<Publication>, Contacts?: FSharpList<Person>, Studies?: FSharpList<Study>, Comments?: FSharpList<Comment$>, Remarks?: FSharpList<Remark>): Investigation {
 ...
 */
export function Investigation_getContacts_33B81164(investigation: Investigation): Option<FSharpList<Person>> {
 ...
 */
export function Investigation_getPublications_33B81164(investigation: Investigation): Option<FSharpList<Publication>> {
 ...
 */
export function Investigation_getOntologies_33B81164(investigation: Investigation): Option<FSharpList<OntologySourceReference>> {
 ...
 */
export function Investigation_getStudies_33B81164(investigation: Investigation): FSharpList<Study> {
 ...
 */
export function Investigation_getComments_33B81164(investigation: Investigation): Option<FSharpList<Comment$>> {
 ...
 */
export function Investigation_getRemarks_33B81164(investigation: Investigation): FSharpList<Remark> {
...
export function Investigation_update_33B81164(investigation: Investigation): Investigation {
    try {
        return new Investigation(investigation.ID, investigation.FileName, investigation.Identifier, investigation.Title, investigation.Description, investigation.SubmissionDate, investigation.PublicReleaseDate, investigation.OntologySourceReferences, investigation.Publications, investigation.Contacts, map<FSharpList<Study>, FSharpList<Study>>((list: FSharpList<Study>): FSharpList<Study> => map_1<Study, Study>(Study_update_7312BC8B, list), investigation.Studies), investigation.Comments, investigation.Remarks);
    }
    catch (err: any) {
