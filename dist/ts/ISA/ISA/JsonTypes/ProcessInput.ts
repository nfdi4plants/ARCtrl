...
import { Source_create_7A281ED9, Source_getUnits_Z28BE5327, Source_setCharacteristicValues, Source_get_empty, Source_$reflection, Source } from "./Source.js";
import { printf, toText } from "../../../fable_modules/fable-library-ts/String.js";
import { Material_create_Z31BE6CDD, Material_getUnits_Z42815C11, Material_setCharacteristicValues, Material_$reflection, Material } from "./Material.js";
import { Data_create_Z326CF519, Data_$reflection, Data } from "./Data.js";
import { Sample_create_E50ED22, Sample_getUnits_Z29207F1E, Sample_setCharacteristicValues, Sample_$reflection, Sample } from "./Sample.js";
 ...
 */
export function ProcessInput_tryGetName_102B6859(pi: ProcessInput_$union): Option<string> {
 ...
 * Returns name of processInput
 */
export function ProcessInput_getName_102B6859(pi: ProcessInput_$union): string {
 ...
 */
export function ProcessInput_isSample_102B6859(pi: ProcessInput_$union): boolean {
    if (pi.tag === /* Sample */ 1) {
        return true;
    }
    else {
 ...
 */
export function ProcessInput_isSource_102B6859(pi: ProcessInput_$union): boolean {
    if (pi.tag === /* Source */ 0) {
        return true;
    }
    else {
 ...
 */
export function ProcessInput_isData_102B6859(pi: ProcessInput_$union): boolean {
    if (pi.tag === /* Data */ 2) {
        return true;
    }
    else {
 ...
 */
export function ProcessInput_isMaterial_102B6859(pi: ProcessInput_$union): boolean {
 ...
 */
export function ProcessInput_trySample_102B6859(pi: ProcessInput_$union): Option<Sample> {
    if (pi.tag === /* Sample */ 1) {
        return pi.fields[0];
    }
    else {
 ...
 */
export function ProcessInput_trySource_102B6859(pi: ProcessInput_$union): Option<Source> {
    if (pi.tag === /* Source */ 0) {
        return pi.fields[0];
    }
    else {
 ...
 */
export function ProcessInput_tryData_102B6859(pi: ProcessInput_$union): Option<Data> {
    if (pi.tag === /* Data */ 2) {
        return pi.fields[0];
    }
    else {
 ...
 */
export function ProcessInput_tryMaterial_102B6859(pi: ProcessInput_$union): Option<Material> {
    if (pi.tag === /* Material */ 3) {
        return pi.fields[0];
    }
    else {
 ...
 */
export function ProcessInput_tryGetCharacteristicValues_102B6859(pi: ProcessInput_$union): Option<FSharpList<MaterialAttributeValue>> {
    switch (pi.tag) {
        case /* Source */ 0:
 ...
 * If given process input contains characteristics, returns them
 */
export function ProcessInput_tryGetCharacteristics_102B6859(pi: ProcessInput_$union): Option<FSharpList<MaterialAttribute>> {
    return map<FSharpList<MaterialAttributeValue>, FSharpList<MaterialAttribute>>((list: FSharpList<MaterialAttributeValue>): FSharpList<MaterialAttribute> => choose<MaterialAttributeValue, MaterialAttribute>((c: MaterialAttributeValue): Option<MaterialAttribute> => c.Category, list), ProcessInput_tryGetCharacteristicValues_102B6859(pi));
}

export function ProcessInput_getCharacteristicValues_102B6859(pi: ProcessInput_$union): FSharpList<MaterialAttributeValue> {
    return defaultArg(ProcessInput_tryGetCharacteristicValues_102B6859(pi), empty<MaterialAttributeValue>());
}

/**
 * If given process output contains units, returns them
 */
export function ProcessInput_getUnits_102B6859(pi: ProcessInput_$union): FSharpList<OntologyAnnotation> {
    switch (pi.tag) {
        case /* Sample */ 1:
...
export function ProcessInput_createSource_7888CE42(name: string, characteristics?: FSharpList<MaterialAttributeValue>): ProcessInput_$union {
    return ProcessInput_Source(Source_create_7A281ED9(void 0, name, unwrap(characteristics)));
}

export function ProcessInput_createSample_Z6DF16D07(name: string, characteristics?: FSharpList<MaterialAttributeValue>, factors?: FSharpList<FactorValue>, derivesFrom?: FSharpList<Source>): ProcessInput_$union {
    return ProcessInput_Sample(Sample_create_E50ED22(void 0, name, unwrap(characteristics), unwrap(factors), unwrap(derivesFrom)));
}

export function ProcessInput_createMaterial_2363974C(name: string, characteristics?: FSharpList<MaterialAttributeValue>, derivesFrom?: FSharpList<Material>): ProcessInput_$union {
    return ProcessInput_Material(Material_create_Z31BE6CDD(void 0, name, void 0, unwrap(characteristics), unwrap(derivesFrom)));
}

export function ProcessInput_createImageFile_Z721C83C5(name: string): ProcessInput_$union {
    return ProcessInput_Data(Data_create_Z326CF519(void 0, name, DataFile_ImageFile()));
}

export function ProcessInput_createRawData_Z721C83C5(name: string): ProcessInput_$union {
    return ProcessInput_Data(Data_create_Z326CF519(void 0, name, DataFile_RawDataFile()));
}

export function ProcessInput_createDerivedData_Z721C83C5(name: string): ProcessInput_$union {
    return ProcessInput_Data(Data_create_Z326CF519(void 0, name, DataFile_DerivedDataFile()));
}
