...
import { Material_create_Z31BE6CDD, Material_getUnits_Z42815C11, Material_$reflection, Material } from "./Material.js";
...
import { Sample_create_E50ED22, Sample_getUnits_Z29207F1E, Sample_setFactorValues, Sample_get_empty, Sample_$reflection, Sample } from "./Sample.js";
 ...
 */
export function ProcessOutput_tryGetName_11830B70(po: ProcessOutput_$union): Option<string> {
 ...
 */
export function ProcessOutput_getName_11830B70(po: ProcessOutput_$union): string {
 ...
 */
export function ProcessOutput_isSample_11830B70(po: ProcessOutput_$union): boolean {
    if (po.tag === /* Sample */ 0) {
        return true;
    }
    else {
 ...
 */
export function ProcessOutput_isData_11830B70(po: ProcessOutput_$union): boolean {
    if (po.tag === /* Data */ 1) {
        return true;
    }
    else {
 ...
 */
export function ProcessOutput_isMaterial_11830B70(po: ProcessOutput_$union): boolean {
 ...
 */
export function ProcessOutput_trySample_11830B70(po: ProcessOutput_$union): Option<Sample> {
    if (po.tag === /* Sample */ 0) {
        return po.fields[0];
    }
    else {
 ...
 */
export function ProcessOutput_tryData_11830B70(po: ProcessOutput_$union): Option<Data> {
    if (po.tag === /* Data */ 1) {
        return po.fields[0];
    }
    else {
 ...
 */
export function ProcessOutput_tryMaterial_11830B70(po: ProcessOutput_$union): Option<Material> {
    if (po.tag === /* Material */ 2) {
        return po.fields[0];
    }
    else {
 ...
 */
export function ProcessOutput_tryGetCharacteristicValues_11830B70(po: ProcessOutput_$union): Option<FSharpList<MaterialAttributeValue>> {
    switch (po.tag) {
        case /* Material */ 2:
 ...
 * If given process output contains characteristics, returns them
 */
export function ProcessOutput_tryGetCharacteristics_11830B70(po: ProcessOutput_$union): Option<FSharpList<MaterialAttribute>> {
    return map<FSharpList<MaterialAttributeValue>, FSharpList<MaterialAttribute>>((list: FSharpList<MaterialAttributeValue>): FSharpList<MaterialAttribute> => choose<MaterialAttributeValue, MaterialAttribute>((c: MaterialAttributeValue): Option<MaterialAttribute> => c.Category, list), ProcessOutput_tryGetCharacteristicValues_11830B70(po));
}

/**
 * If given process output contains factors, returns them
 */
export function ProcessOutput_tryGetFactorValues_11830B70(po: ProcessOutput_$union): Option<FSharpList<FactorValue>> {
    switch (po.tag) {
        case /* Material */ 2:
            return void 0;
        case /* Data */ 1:
...
export function ProcessOutput_getFactorValues_11830B70(po: ProcessOutput_$union): FSharpList<FactorValue> {
    return defaultArg(ProcessOutput_tryGetFactorValues_11830B70(po), empty<FactorValue>());
}

/**
 * If given process output contains units, returns them
 */
export function ProcessOutput_getUnits_11830B70(po: ProcessOutput_$union): FSharpList<OntologyAnnotation> {
    switch (po.tag) {
        case /* Material */ 2:
...
export function ProcessOutput_createSample_Z6DF16D07(name: string, characteristics?: FSharpList<MaterialAttributeValue>, factors?: FSharpList<FactorValue>, derivesFrom?: FSharpList<Source>): ProcessOutput_$union {
    return ProcessOutput_Sample(Sample_create_E50ED22(void 0, name, unwrap(characteristics), unwrap(factors), unwrap(derivesFrom)));
}

export function ProcessOutput_createMaterial_2363974C(name: string, characteristics?: FSharpList<MaterialAttributeValue>, derivesFrom?: FSharpList<Material>): ProcessOutput_$union {
    return ProcessOutput_Material(Material_create_Z31BE6CDD(void 0, name, void 0, unwrap(characteristics), unwrap(derivesFrom)));
}

export function ProcessOutput_createImageFile_Z721C83C5(name: string): ProcessOutput_$union {
    return ProcessOutput_Data(Data_create_Z326CF519(void 0, name, DataFile_ImageFile()));
}

export function ProcessOutput_createRawData_Z721C83C5(name: string): ProcessOutput_$union {
    return ProcessOutput_Data(Data_create_Z326CF519(void 0, name, DataFile_RawDataFile()));
}

export function ProcessOutput_createDerivedData_Z721C83C5(name: string): ProcessOutput_$union {
    return ProcessOutput_Data(Data_create_Z326CF519(void 0, name, DataFile_DerivedDataFile()));
}
