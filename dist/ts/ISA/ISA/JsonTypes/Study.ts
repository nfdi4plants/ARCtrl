...
import { Assay_update_722A269D, Assay_updateProtocols, Assay_getMaterials_722A269D, Assay_getSamples_722A269D, Assay_getSources_722A269D, Assay_getUnitCategories_722A269D, Assay_getFactors_722A269D, Assay_getCharacteristics_722A269D, Assay_getProtocols_722A269D, Assay_$reflection, Assay } from "./Assay.js";
 ...
 */
export function Study_getAssays_7312BC8B(study: Study): FSharpList<Assay> {
 ...
 */
export function Study_getContacts_7312BC8B(study: Study): FSharpList<Person> {
 ...
 */
export function Study_getPublications_7312BC8B(study: Study): FSharpList<Publication> {
 ...
 */
export function Study_getDescriptors_7312BC8B(study: Study): FSharpList<OntologyAnnotation> {
 ...
 */
export function Study_getProcesses_7312BC8B(study: Study): FSharpList<Process> {
 ...
 */
export function Study_getProtocols_7312BC8B(study: Study): FSharpList<Protocol> {
    const processSequenceProtocols: FSharpList<Protocol> = getProtocols(Study_getProcesses_7312BC8B(study));
    const assaysProtocols: FSharpList<Protocol> = collect<Assay, Protocol>(Assay_getProtocols_722A269D, Study_getAssays_7312BC8B(study));
 ...
 */
export function Study_getCharacteristics_7312BC8B(study: Study): FSharpList<MaterialAttribute> {
    return List_distinct<MaterialAttribute>(append(getCharacteristics(Study_getProcesses_7312BC8B(study)), append(collect<Assay, MaterialAttribute>(Assay_getCharacteristics_722A269D, Study_getAssays_7312BC8B(study)), defaultArg(study.CharacteristicCategories, empty<MaterialAttribute>()))), {
        Equals: equals,
 ...
 */
export function Study_getFactors_7312BC8B(study: Study): FSharpList<Factor> {
    return List_distinct<Factor>(append(getFactors(Study_getProcesses_7312BC8B(study)), append(collect<Assay, Factor>(Assay_getFactors_722A269D, Study_getAssays_7312BC8B(study)), defaultArg(study.Factors, empty<Factor>()))), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
 ...
 */
export function Study_getUnitCategories_7312BC8B(study: Study): FSharpList<OntologyAnnotation> {
    return List_distinct<OntologyAnnotation>(append(getUnits(Study_getProcesses_7312BC8B(study)), append(collect<Assay, OntologyAnnotation>(Assay_getUnitCategories_722A269D, Study_getAssays_7312BC8B(study)), defaultArg(study.UnitCategories, empty<OntologyAnnotation>()))), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
 ...
 */
export function Study_getSources_7312BC8B(study: Study): FSharpList<Source> {
    const processSequenceSources: FSharpList<Source> = getSources(Study_getProcesses_7312BC8B(study));
    const assaysSources: FSharpList<Source> = collect<Assay, Source>(Assay_getSources_722A269D, Study_getAssays_7312BC8B(study));
    const updateOptions_2: Update_UpdateOptions_$union = Update_UpdateOptions_UpdateByExistingAppendLists();
 ...
 * Returns sources of the study
 */
export function Study_getSamples_7312BC8B(study: Study): FSharpList<Sample> {
    const processSequenceSamples: FSharpList<Sample> = getSamples(Study_getProcesses_7312BC8B(study));
    const assaysSamples: FSharpList<Sample> = collect<Assay, Sample>(Assay_getSamples_722A269D, Study_getAssays_7312BC8B(study));
    const updateOptions_2: Update_UpdateOptions_$union = Update_UpdateOptions_UpdateByExistingAppendLists();
 ...
 */
export function Study_getMaterials_7312BC8B(study: Study): StudyMaterials {
    const processSequenceMaterials: FSharpList<Material> = getMaterials(Study_getProcesses_7312BC8B(study));
    const assaysMaterials: FSharpList<Material> = collect<Assay, Material>((arg_2: Assay): FSharpList<Material> => AssayMaterials_getMaterials_35E61745(Assay_getMaterials_722A269D(arg_2)), Study_getAssays_7312BC8B(study));
...
${err_1.message}`);
    ...
    const sources: FSharpList<Source> = Study_getSources_7312BC8B(study);
    const samples: FSharpList<Sample> = Study_getSamples_7312BC8B(study);
...
export function Study_update_7312BC8B(study: Study): Study {
    try {
        const protocols: FSharpList<Protocol> = Study_getProtocols_7312BC8B(study);
        let Materials: Option<StudyMaterials>;
        const v: StudyMaterials = Study_getMaterials_7312BC8B(study);
        Materials = fromValueWithDefault<StudyMaterials>(StudyMaterials_get_empty(), v);
        const Assays: Option<FSharpList<Assay>> = map_1<FSharpList<Assay>, FSharpList<Assay>>((list: FSharpList<Assay>): FSharpList<Assay> => map<Assay, Assay>((arg_3: Assay): Assay => ((arg_2: Assay): Assay => Assay_updateProtocols(protocols, arg_2))(Assay_update_722A269D(arg_3)), list), study.Assays);
        const Protocols: Option<FSharpList<Protocol>> = fromValueWithDefault<FSharpList<Protocol>>(empty<Protocol>(), protocols);
        const Factors: Option<FSharpList<Factor>> = fromValueWithDefault<FSharpList<Factor>>(empty<Factor>(), Study_getFactors_7312BC8B(study));
        const CharacteristicCategories: Option<FSharpList<MaterialAttribute>> = fromValueWithDefault<FSharpList<MaterialAttribute>>(empty<MaterialAttribute>(), Study_getCharacteristics_7312BC8B(study));
        const UnitCategories: Option<FSharpList<OntologyAnnotation>> = fromValueWithDefault<FSharpList<OntologyAnnotation>>(empty<OntologyAnnotation>(), Study_getUnitCategories_7312BC8B(study));
