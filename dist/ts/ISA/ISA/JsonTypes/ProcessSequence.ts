...
import { Process_updateProtocol, Process_getMaterials_716E708F, Process_getSamples_716E708F, Process_getSources_716E708F, Process_getData_716E708F, Process_getUnits_716E708F, Process_getFactors_716E708F, Process_tryGetOutputsWithFactorBy, Process_tryGetOutputsWithCharacteristicBy, Process_tryGetInputsWithCharacteristicBy, Process_getCharacteristics_716E708F, Process_getParameters_716E708F, Process_tryGetOutputsWithParameterBy, Process_tryGetInputsWithParameterBy, Process } from "./Process.js";
...
import { ProcessInput__get_Name, ProcessInput_getName_102B6859, ProcessInput_$union } from "./ProcessInput.js";
import { ProcessParameterValue } from "./ProcessParameterValue.js";
import { ProtocolParameter } from "./ProtocolParameter.js";
import { ProcessOutput__get_Name, ProcessOutput_getName_11830B70, ProcessOutput_$union } from "./ProcessOutput.js";
...
export function getParameters(processSequence: FSharpList<Process>): FSharpList<ProtocolParameter> {
    return List_distinct<ProtocolParameter>(collect<Process, ProtocolParameter>(Process_getParameters_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
...
export function getCharacteristics(processSequence: FSharpList<Process>): FSharpList<MaterialAttribute> {
    return List_distinct<MaterialAttribute>(collect<Process, MaterialAttribute>(Process_getCharacteristics_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
...
export function getFactors(processSequence: FSharpList<Process>): FSharpList<Factor> {
    return List_distinct<Factor>(collect<Process, Factor>(Process_getFactors_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
...
export function getRootInputs(processSequence: FSharpList<Process>): FSharpList<ProcessInput_$union> {
    ...
    const outputs: FSharpSet<string> = ofList<string>(collect<Process, string>((p_1: Process): FSharpList<string> => map<ProcessOutput_$union, string>(ProcessOutput_getName_11830B70, defaultArg(p_1.Outputs, empty<ProcessOutput_$union>())), processSequence), {
        Compare: comparePrimitives,
    });
    return filter<ProcessInput_$union>((i: ProcessInput_$union): boolean => !FSharpSet__Contains(outputs, ProcessInput_getName_102B6859(i)), inputs);
}
...
export function getFinalOutputs(processSequence: FSharpList<Process>): FSharpList<ProcessOutput_$union> {
    const inputs: FSharpSet<string> = ofList<string>(collect<Process, string>((p: Process): FSharpList<string> => map<ProcessInput_$union, string>(ProcessInput_getName_102B6859, defaultArg(p.Inputs, empty<ProcessInput_$union>())), processSequence), {
        Compare: comparePrimitives,
    });
    return filter<ProcessOutput_$union>((o: ProcessOutput_$union): boolean => !FSharpSet__Contains(inputs, ProcessOutput_getName_11830B70(o)), collect<Process, ProcessOutput_$union>((p_1: Process): FSharpList<ProcessOutput_$union> => defaultArg(p_1.Outputs, empty<ProcessOutput_$union>()), processSequence));
}
...
export function getUnits(processSequence: FSharpList<Process>): FSharpList<OntologyAnnotation> {
    return List_distinct<OntologyAnnotation>(collect<Process, OntologyAnnotation>(Process_getUnits_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
...
export function getData(processSequence: FSharpList<Process>): FSharpList<Data> {
    return List_distinct<Data>(collect<Process, Data>(Process_getData_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
...
export function getSources(processSequence: FSharpList<Process>): FSharpList<Source> {
    return List_distinct<Source>(collect<Process, Source>(Process_getSources_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
...
export function getSamples(processSequence: FSharpList<Process>): FSharpList<Sample> {
    return List_distinct<Sample>(collect<Process, Sample>(Process_getSamples_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
...
export function getMaterials(processSequence: FSharpList<Process>): FSharpList<Material> {
    return List_distinct<Material>(collect<Process, Material>(Process_getMaterials_716E708F, processSequence), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
