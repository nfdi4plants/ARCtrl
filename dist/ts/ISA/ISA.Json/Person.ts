...
import { tryPick } from "../../fable_modules/fable-library-ts/Array.js";
...
import { IGetters, array as array_1, string, IOptionalGetter, object as object_23 } from "../../fable_modules/Thoth.Json.10.1.0/Decode.fs.js";
...
export function genID(p: Person): string {
    ...
    if (matchValue == null) {
        ...
        const matchValue_1: Option<Comment$[]> = p.Comments;
...
export function decoder(options: ConverterOptions): ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<Person, [string, ErrorReason_$union]>)) {
    return (path_10: string): ((arg0: any) => FSharpResult$2_$union<Person, [string, ErrorReason_$union]>) => ((v: any): FSharpResult$2_$union<Person, [string, ErrorReason_$union]> => object_23<Person>((get$: IGetters): Person => {
        let objectArg_2: IOptionalGetter, objectArg_3: IOptionalGetter, objectArg_4: IOptionalGetter, objectArg_5: IOptionalGetter, objectArg_6: IOptionalGetter, objectArg_7: IOptionalGetter, objectArg_8: IOptionalGetter, arg_19: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<OntologyAnnotation[], [string, ErrorReason_$union]>)), decoder_1: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<OntologyAnnotation, [string, ErrorReason_$union]>)), objectArg_9: IOptionalGetter, arg_21: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<Comment$[], [string, ErrorReason_$union]>)), decoder_2: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<Comment$, [string, ErrorReason_$union]>)), objectArg_10: IOptionalGetter;
        ...
        return new Person(ID, (objectArg_2 = get$.Optional, objectArg_2.Field<string>("lastName", string)), FirstName, (objectArg_3 = get$.Optional, objectArg_3.Field<string>("midInitials", string)), (objectArg_4 = get$.Optional, objectArg_4.Field<string>("email", string)), (objectArg_5 = get$.Optional, objectArg_5.Field<string>("phone", string)), (objectArg_6 = get$.Optional, objectArg_6.Field<string>("fax", string)), (objectArg_7 = get$.Optional, objectArg_7.Field<string>("address", string)), (objectArg_8 = get$.Optional, objectArg_8.Field<string>("affiliation", string)), (arg_19 = ((decoder_1 = OntologyAnnotation_decoder(options), (path_8: string): ((arg0: any) => FSharpResult$2_$union<OntologyAnnotation[], [string, ErrorReason_$union]>) => ((value_8: any): FSharpResult$2_$union<OntologyAnnotation[], [string, ErrorReason_$union]> => array_1<OntologyAnnotation>(uncurry2(decoder_1), path_8, value_8)))), (objectArg_9 = get$.Optional, objectArg_9.Field<OntologyAnnotation[]>("roles", uncurry2(arg_19)))), (arg_21 = ((decoder_2 = decoder_3(options), (path_9: string): ((arg0: any) => FSharpResult$2_$union<Comment$[], [string, ErrorReason_$union]>) => ((value_9: any): FSharpResult$2_$union<Comment$[], [string, ErrorReason_$union]> => array_1<Comment$>(uncurry2(decoder_2), path_9, value_9)))), (objectArg_10 = get$.Optional, objectArg_10.Field<Comment$[]>("comments", uncurry2(arg_21)))));
    }, path_10, v));
}
