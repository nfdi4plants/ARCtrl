...
import { append as append_1, choose, equalsWith, tail, head, map } from "../fable_modules/fable-library-ts/Array.js";
...
export class FileSystemTree<Tag extends keyof FileSystemTree_$cases> extends Union<Tag, FileSystemTree_$cases[Tag][0]> {
    ...
    static createRootFolder(children: FileSystemTree_$union[]): FileSystemTree_$union {
    ...
    Union(otherFST: FileSystemTree_$union): FileSystemTree_$union {
        let array_1: string[];
        const this$ = this as FileSystemTree_$union;
        const arg: string[] = Array_distinct<string>((array_1 = this$.ToFilePaths(), append_1<string>(otherFST.ToFilePaths(), array_1)), {
