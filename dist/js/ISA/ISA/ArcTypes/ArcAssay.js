import { defaultArg, map as map_1, unwrap } from "../../../fable_modules/fable-library.4.1.4/Option.js";
...
export class ArcAssay {
    ...
    static fromAssay(a) {
        ...
        return ArcAssay.create(identifer, unwrap(map_1((x) => x.Copy(), a.MeasurementType)), unwrap(map_1((x_1) => x_1.Copy(), a.TechnologyType)), unwrap(a.TechnologyPlatform), unwrap(tables), void 0, unwrap(map_1(toArray, a.Comments)));
    }
}
