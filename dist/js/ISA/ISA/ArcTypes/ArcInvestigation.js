import { map as map_3, defaultArg, unwrap } from "../../../fable_modules/fable-library.4.1.4/Option.js";
import { toList, removeAt, tryFindIndex, map } from "../../../fable_modules/fable-library.4.1.4/Seq.js";
import { ArcStudy } from "./ArcStudy.js";
import { map as map_1, tryFind, removeInPlace } from "../../../fable_modules/fable-library.4.1.4/Array.js";
...
export class ArcInvestigation {
    ...
    Copy() {
        ...
        const nextRemarks = map_1((c_1) => c_1.Copy(), this$.Remarks);
        const nextContacts = map_1((c_2) => c_2.Copy(), this$.Contacts);
        const nextPublications = map_1((c_3) => c_3.Copy(), this$.Publications);
        const nextOntologySourceReferences = map_1((c_4) => c_4.Copy(), this$.OntologySourceReferences);
    ...
    ToInvestigation() {
        const this$ = this;
        const studies = fromValueWithDefault(empty(), map_2((a) => a.ToStudy(), toList(this$.Studies)));
    ...
    static fromInvestigation(i) {
        ...
        const studies = map_3((arg_2) => {
            const arg_1 = map_2((arg) => ArcStudy.fromStudy(arg), arg_2);
            return Array.from(arg_1);
        }, i.Studies);
        return ArcInvestigation.create(identifer, i.Title, i.Description, i.SubmissionDate, i.PublicReleaseDate, void 0, map_3(toArray, i.Publications), map_3(toArray, i.Contacts), studies, map_3(toArray, i.Comments));
    }
}
