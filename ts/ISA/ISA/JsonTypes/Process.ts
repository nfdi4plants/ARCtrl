...
import { ProcessInput_tryMaterial_Z38E7E853, ProcessInput_trySample_Z38E7E853, ProcessInput_tryData_Z38E7E853, ProcessInput_trySource_Z38E7E853, ProcessInput_tryGetCharacteristicValues_Z38E7E853, ProcessInput_$reflection, ProcessInput_$union } from "./ProcessInput.js";
import { parse, int32 } from "../../../fable_modules/fable-library-ts/Int32.js";
import { ProcessOutput_tryGetFactorValues_Z4A02997C, ProcessOutput_tryGetCharacteristicValues_Z4A02997C, ProcessOutput_$reflection, ProcessOutput_$union } from "./ProcessOutput.js";
...
export function Process_create_236DF576(Id?: string, Name?: string, ExecutesProtocol?: Protocol, ParameterValues?: FSharpList<ProcessParameterValue>, Performer?: string, Date$?: string, PreviousProcess?: Process, NextProcess?: Process, Inputs?: FSharpList<ProcessInput_$union>, Outputs?: FSharpList<ProcessOutput_$union>, Comments?: FSharpList<Comment$>): Process {
 ...
 */
export function Process_tryGetProtocolName_30EF9E7B(p: Process): Option<string> {
 ...
 * Returns the name of the protocol the given process executes
 */
export function Process_getProtocolName_30EF9E7B(p: Process): string {
 ...
 */
export function Process_getParameterValues_30EF9E7B(p: Process): FSharpList<ProcessParameterValue> {
 ...
 */
export function Process_getParameters_30EF9E7B(p: Process): FSharpList<ProtocolParameter> {
    return choose<ProcessParameterValue, ProtocolParameter>((pv: ProcessParameterValue): Option<ProtocolParameter> => pv.Category, Process_getParameterValues_30EF9E7B(p));
}

/**
 * Returns the characteristics describing the inputs of the process
 */
export function Process_getInputCharacteristicValues_30EF9E7B(p: Process): FSharpList<MaterialAttributeValue> {
    const matchValue: Option<FSharpList<ProcessInput_$union>> = p.Inputs;
    if (matchValue == null) {
        return empty<MaterialAttributeValue>();
    }
    else {
        return List_distinct<MaterialAttributeValue>(collect<ProcessInput_$union, MaterialAttributeValue>((inp: ProcessInput_$union): FSharpList<MaterialAttributeValue> => defaultArg(ProcessInput_tryGetCharacteristicValues_Z38E7E853(inp), empty<MaterialAttributeValue>()), value_4(matchValue)), {
            Equals: equals,
 ...
 */
export function Process_getOutputCharacteristicValues_30EF9E7B(p: Process): FSharpList<MaterialAttributeValue> {
    const matchValue: Option<FSharpList<ProcessOutput_$union>> = p.Outputs;
    if (matchValue == null) {
        return empty<MaterialAttributeValue>();
    }
    else {
        return List_distinct<MaterialAttributeValue>(collect<ProcessOutput_$union, MaterialAttributeValue>((out: ProcessOutput_$union): FSharpList<MaterialAttributeValue> => defaultArg(ProcessOutput_tryGetCharacteristicValues_Z4A02997C(out), empty<MaterialAttributeValue>()), value_4(matchValue)), {
            Equals: equals,
            GetHashCode: safeHash,
        });
    }
 ...
 */
export function Process_getCharacteristicValues_30EF9E7B(p: Process): FSharpList<MaterialAttributeValue> {
    return List_distinct<MaterialAttributeValue>(append(Process_getInputCharacteristicValues_30EF9E7B(p), Process_getOutputCharacteristicValues_30EF9E7B(p)), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
 ...
 */
export function Process_getCharacteristics_30EF9E7B(p: Process): FSharpList<MaterialAttribute> {
    return List_distinct<MaterialAttribute>(choose<MaterialAttributeValue, MaterialAttribute>((cv: MaterialAttributeValue): Option<MaterialAttribute> => cv.Category, Process_getCharacteristicValues_30EF9E7B(p)), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
 ...
 */
export function Process_getFactorValues_30EF9E7B(p: Process): FSharpList<FactorValue> {
    return List_distinct<FactorValue>(collect<ProcessOutput_$union, FactorValue>((arg_1: ProcessOutput_$union): FSharpList<FactorValue> => defaultArg(ProcessOutput_tryGetFactorValues_Z4A02997C(arg_1), empty<FactorValue>()), defaultArg(p.Outputs, empty<ProcessOutput_$union>())), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
 ...
 */
export function Process_getFactors_30EF9E7B(p: Process): FSharpList<Factor> {
    return List_distinct<Factor>(choose<FactorValue, Factor>((fv: FactorValue): Option<Factor> => fv.Category, Process_getFactorValues_30EF9E7B(p)), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
 ...
 */
export function Process_getUnits_30EF9E7B(p: Process): FSharpList<OntologyAnnotation> {
    return append(choose<MaterialAttributeValue, OntologyAnnotation>((cv: MaterialAttributeValue): Option<OntologyAnnotation> => cv.Unit, Process_getCharacteristicValues_30EF9E7B(p)), append(choose<ProcessParameterValue, OntologyAnnotation>((pv: ProcessParameterValue): Option<OntologyAnnotation> => pv.Unit, Process_getParameterValues_30EF9E7B(p)), choose<FactorValue, OntologyAnnotation>((fv: FactorValue): Option<OntologyAnnotation> => fv.Unit, Process_getFactorValues_30EF9E7B(p))));
}
...
export function Process_tryGetInputsWithCharacteristicBy(predicate: ((arg0: MaterialAttribute) => boolean), p: Process): Option<FSharpList<[ProcessInput_$union, MaterialAttributeValue]>> {
    ...
    if (matchValue == null) {
        ...
        }, defaultArg(ProcessInput_tryGetCharacteristicValues_Z38E7E853(i), empty<MaterialAttributeValue>())), value_4(matchValue)));
    }
}
...
export function Process_tryGetOutputsWithCharacteristicBy(predicate: ((arg0: MaterialAttribute) => boolean), p: Process): Option<FSharpList<[ProcessOutput_$union, MaterialAttributeValue]>> {
    ...
    switch (matchResult) {
        case 0:
            ...
            }, defaultArg(ProcessInput_tryGetCharacteristicValues_Z38E7E853(tupledArg[0]), empty<MaterialAttributeValue>())), zip<ProcessInput_$union, ProcessOutput_$union>(is!, os!)));
        default:
            return void 0;
    }
}
...
export function Process_tryGetOutputsWithFactorBy(predicate: ((arg0: Factor) => boolean), p: Process): Option<FSharpList<[ProcessOutput_$union, FactorValue]>> {
    ...
    if (matchValue == null) {
        ...
        }, defaultArg(ProcessOutput_tryGetFactorValues_Z4A02997C(o), empty<FactorValue>())), value_4(matchValue)));
    }
}

export function Process_getSources_30EF9E7B(p: Process): FSharpList<Source> {
    return List_distinct<Source>(choose<ProcessInput_$union, Source>(ProcessInput_trySource_Z38E7E853, defaultArg(p.Inputs, empty<ProcessInput_$union>())), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}

export function Process_getData_30EF9E7B(p: Process): FSharpList<Data> {
    return List_distinct<Data>(append(choose<ProcessInput_$union, Data>(ProcessInput_tryData_Z38E7E853, defaultArg(p.Inputs, empty<ProcessInput_$union>())), choose<ProcessInput_$union, Data>(ProcessInput_tryData_Z38E7E853, defaultArg(p.Inputs, empty<ProcessInput_$union>()))), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}

export function Process_getSamples_30EF9E7B(p: Process): FSharpList<Sample> {
    return List_distinct<Sample>(append(choose<ProcessInput_$union, Sample>(ProcessInput_trySample_Z38E7E853, defaultArg(p.Inputs, empty<ProcessInput_$union>())), choose<ProcessInput_$union, Sample>(ProcessInput_trySample_Z38E7E853, defaultArg(p.Inputs, empty<ProcessInput_$union>()))), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}

export function Process_getMaterials_30EF9E7B(p: Process): FSharpList<Material> {
    return List_distinct<Material>(append(choose<ProcessInput_$union, Material>(ProcessInput_tryMaterial_Z38E7E853, defaultArg(p.Inputs, empty<ProcessInput_$union>())), choose<ProcessInput_$union, Material>(ProcessInput_tryMaterial_Z38E7E853, defaultArg(p.Inputs, empty<ProcessInput_$union>()))), {
        Equals: equals,
        GetHashCode: safeHash,
    });
}
