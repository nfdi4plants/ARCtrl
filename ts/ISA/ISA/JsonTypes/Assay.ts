...
export function Assay_create_ABF59A4(Id?: string, FileName?: string, MeasurementType?: OntologyAnnotation, TechnologyType?: OntologyAnnotation, TechnologyPlatform?: string, DataFiles?: FSharpList<Data>, Materials?: AssayMaterials, CharacteristicCategories?: FSharpList<MaterialAttribute>, UnitCategories?: FSharpList<OntologyAnnotation>, ProcessSequence?: FSharpList<Process>, Comments?: FSharpList<Comment$>): Assay {
 ...
 */
export function Assay_getComments_Z269B5B97(assay: Assay): Option<FSharpList<Comment$>> {
 ...
 */
export function Assay_getData_Z269B5B97(assay: Assay): FSharpList<Data> {
 ...
 */
export function Assay_getUnitCategories_Z269B5B97(assay: Assay): FSharpList<OntologyAnnotation> {
 ...
 */
export function Assay_getCharacteristics_Z269B5B97(assay: Assay): FSharpList<MaterialAttribute> {
 ...
 */
export function Assay_getMeasurementType_Z269B5B97(assay: Assay): Option<OntologyAnnotation> {
 ...
 */
export function Assay_getTechnologyType_Z269B5B97(assay: Assay): Option<OntologyAnnotation> {
 ...
 */
export function Assay_getProcesses_Z269B5B97(assay: Assay): FSharpList<Process> {
...
export function Assay_getSources_Z269B5B97(assay: Assay): FSharpList<Source> {
    return getSources(Assay_getProcesses_Z269B5B97(assay));
}

export function Assay_getSamples_Z269B5B97(assay: Assay): FSharpList<Sample> {
 ...
 */
export function Assay_getMaterials_Z269B5B97(assay: Assay): AssayMaterials {
 ...
 */
export function Assay_getParameters_Z269B5B97(assay: Assay): Option<FSharpList<ProtocolParameter>> {
 ...
 */
export function Assay_getFactors_Z269B5B97(assay: Assay): FSharpList<Factor> {
 ...
 */
export function Assay_getProtocols_Z269B5B97(assay: Assay): FSharpList<Protocol> {
    return getProtocols(defaultArg(assay.ProcessSequence, empty<Process>()));
}

export function Assay_update_Z269B5B97(assay: Assay): Assay {
    let v_1: AssayMaterials;
    try {
        return new Assay(assay.ID, assay.FileName, assay.MeasurementType, assay.TechnologyType, assay.TechnologyPlatform, fromValueWithDefault<FSharpList<Data>>(empty<Data>(), Assay_getData_Z269B5B97(assay)), (v_1 = Assay_getMaterials_Z269B5B97(assay), fromValueWithDefault<AssayMaterials>(AssayMaterials_get_empty(), v_1)), fromValueWithDefault<FSharpList<MaterialAttribute>>(empty<MaterialAttribute>(), Assay_getCharacteristics_Z269B5B97(assay)), fromValueWithDefault<FSharpList<OntologyAnnotation>>(empty<OntologyAnnotation>(), Assay_getUnitCategories_Z269B5B97(assay)), assay.ProcessSequence, assay.Comments);
    }
    catch (err: any) {
