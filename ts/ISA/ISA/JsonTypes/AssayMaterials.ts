...
export function AssayMaterials_create_1CB3546D(Samples?: FSharpList<Sample>, OtherMaterials?: FSharpList<Material>): AssayMaterials {
...
export function AssayMaterials_getMaterials_E3447B1(am: AssayMaterials): FSharpList<Material> {
    return defaultArg(am.OtherMaterials, empty<Material>());
}

export function AssayMaterials_getSamples_E3447B1(am: AssayMaterials): FSharpList<Sample> {
