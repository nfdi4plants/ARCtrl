...
import { OntologyAnnotation_fromString_Z7D8EB286, OntologyAnnotation_$reflection, OntologyAnnotation, OntologyAnnotation__get_NameText } from "./OntologyAnnotation.js";
...
import { AnnotationValue_$union, AnnotationValue_toString_Z3C00A204 } from "./AnnotationValue.js";
...
export function Value_fromOptions(value: Option<string>, termSource: Option<string>, termAccesssion: Option<string>): Option<Value_$union> {
    ...
    switch (matchResult) {
        ...
        case 1:
            return void 0;
        default:
            return Value_Ontology(OntologyAnnotation_fromString_Z7D8EB286(defaultArg(value, ""), termSource, termAccesssion));
    }
}

export function Value_toOptions_Z277CD705(value: Value_$union): [Option<string>, Option<string>, Option<string>] {
    switch (value.tag) {
        case /* Int */ 1:
        ...
        default: {
            ...
            return [map<AnnotationValue_$union, string>(AnnotationValue_toString_Z3C00A204, oa.Name), oa.TermAccessionNumber, oa.TermSourceREF] as [Option<string>, Option<string>, Option<string>];
        }
    }
}
...
export function Value_getText_Z277CD705(v: Value_$union): string {
