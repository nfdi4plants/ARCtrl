...
export function StudyMaterials_create_Z460D555F(Sources?: FSharpList<Source>, Samples?: FSharpList<Sample>, OtherMaterials?: FSharpList<Material>): StudyMaterials {
...
export function StudyMaterials_getMaterials_6A1922E7(am: StudyMaterials): FSharpList<Material> {
    return defaultArg(am.OtherMaterials, empty<Material>());
}

export function StudyMaterials_getSamples_6A1922E7(am: StudyMaterials): FSharpList<Sample> {
    return defaultArg(am.Samples, empty<Sample>());
}

export function StudyMaterials_getSources_6A1922E7(am: StudyMaterials): FSharpList<Source> {
