...
export function Source_create_Z32235993(Id?: string, Name?: string, Characteristics?: FSharpList<MaterialAttributeValue>): Source {
...
export function Source_getUnits_Z220A6393(m: Source): FSharpList<OntologyAnnotation> {
