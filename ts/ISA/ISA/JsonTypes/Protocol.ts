...
export function Protocol_create_Z4D717767(Id?: string, Name?: string, ProtocolType?: OntologyAnnotation, Description?: string, Uri?: string, Version?: string, Parameters?: FSharpList<ProtocolParameter>, Components?: FSharpList<Component>, Comments?: FSharpList<Comment$>): Protocol {
 ...
 */
export function Protocol_getComments_4D8AC666(protocol: Protocol): Option<FSharpList<Comment$>> {
 ...
 */
export function Protocol_getProtocolType_4D8AC666(protocol: Protocol): Option<OntologyAnnotation> {
 ...
 */
export function Protocol_getVersion_4D8AC666(protocol: Protocol): Option<string> {
 ...
 */
export function Protocol_getName_4D8AC666(protocol: Protocol): Option<string> {
 ...
 */
export function Protocol_getDescription_4D8AC666(protocol: Protocol): Option<string> {
 ...
 */
export function Protocol_getUri_4D8AC666(protocol: Protocol): Option<string> {
    return protocol.Uri;
}
 ...
 */
export function Protocol_getComponents_4D8AC666(protocol: Protocol): Option<FSharpList<Component>> {
 ...
 */
export function Protocol_getParameters_4D8AC666(protocol: Protocol): Option<FSharpList<ProtocolParameter>> {
