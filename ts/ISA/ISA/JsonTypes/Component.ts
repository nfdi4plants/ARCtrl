...
export function Component_create_Z33AADEE0(Name?: string, Value?: Value_$union, Unit?: OntologyAnnotation, ComponentType?: OntologyAnnotation): Component {
...
export function Component_decomposeName_Z721C83C5(name: string): [Value_$union, Option<OntologyAnnotation>] {
    ...
    if (unitr != null) {
        const oa: OntologyAnnotation = OntologyAnnotation_fromTermAnnotation_Z721C83C5((unitr.groups && unitr.groups.ontology) || "");
        ...
        const oa_1: OntologyAnnotation = OntologyAnnotation_fromTermAnnotation_Z721C83C5((r.groups && r.groups.ontology) || "");
 ...
 */
export function Component_fromString_55205B02(name?: string, term?: string, source?: string, accession?: string, comments?: FSharpList<Comment$>): Component {
    let cType: Option<OntologyAnnotation>;
    const v: OntologyAnnotation = OntologyAnnotation_fromString_Z7D8EB286(unwrap(term), unwrap(source), unwrap(accession), unwrap(comments));
    cType = fromValueWithDefault<OntologyAnnotation>(OntologyAnnotation_get_empty(), v);
    if (name == null) {
 ...
 */
export function Component_toString_Z7E9B32A1(c: Component): [string, { TermAccessionNumber: string, TermName: string, TermSourceREF: string }] {
    ...
    oa = defaultArg(map<OntologyAnnotation, { TermAccessionNumber: string, TermName: string, TermSourceREF: string }>(OntologyAnnotation_toString_473B9D79, c.ComponentType), value);
...
export function Component__get_NameText(this$: Component): string {
    return defaultArg(map<OntologyAnnotation, string>(OntologyAnnotation__get_NameText, this$.ComponentType), "");
}
...
export function Component__get_UnitText(this$: Component): string {
    return defaultArg(map<OntologyAnnotation, string>(OntologyAnnotation__get_NameText, this$.ComponentUnit), "");
}
...
export function Component__get_ValueWithUnitText(this$: Component): string {
    const unit: Option<string> = map<OntologyAnnotation, string>(OntologyAnnotation__get_NameText, this$.ComponentUnit);
...
export function Component__MapCategory_65D42856(this$: Component, f: ((arg0: OntologyAnnotation) => OntologyAnnotation)): Component {
...
export function Component__SetCategory_2FC95D30(this$: Component, c: OntologyAnnotation): Component {
