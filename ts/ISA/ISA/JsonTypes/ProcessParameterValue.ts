...
import { ProtocolParameter__SetCategory_2FC95D30, ProtocolParameter_create_2769312B, ProtocolParameter__MapCategory_65D42856, ProtocolParameter__get_TryNameText, ProtocolParameter_$reflection, ProtocolParameter, ProtocolParameter__get_NameText } from "./ProtocolParameter.js";
...
export function ProcessParameterValue_create_2A3A2A47(Category?: ProtocolParameter, Value?: Value_$union, Unit?: OntologyAnnotation): ProcessParameterValue {
...
export function ProcessParameterValue__MapCategory_65D42856(this$: ProcessParameterValue, f: ((arg0: OntologyAnnotation) => OntologyAnnotation)): ProcessParameterValue {
    return new ProcessParameterValue(map<ProtocolParameter, ProtocolParameter>((p: ProtocolParameter): ProtocolParameter => ProtocolParameter__MapCategory_65D42856(p, f), this$.Category), this$.Value, this$.Unit);
}

export function ProcessParameterValue__SetCategory_2FC95D30(this$: ProcessParameterValue, c: OntologyAnnotation): ProcessParameterValue {
    let matchValue: Option<ProtocolParameter>;
    return new ProcessParameterValue((matchValue = this$.Category, (matchValue == null) ? ProtocolParameter_create_2769312B(void 0, c) : ProtocolParameter__SetCategory_2FC95D30(value_3(matchValue), c)), this$.Value, this$.Unit);
}

/**
 * Returns the name of the paramater value as string if it exists
 */
export function ProcessParameterValue_tryGetNameText_39585819(pv: ProcessParameterValue): Option<string> {
 ...
 */
export function ProcessParameterValue_getNameText_39585819(pv: ProcessParameterValue): string {
...
export function ProcessParameterValue_getCategory_39585819(pv: ProcessParameterValue): Option<ProtocolParameter> {
    return pv.Category;
}
