...
import { OntologyAnnotation_$reflection, OntologyAnnotation__get_TermAccessionShort, OntologyAnnotation, OntologyAnnotation_fromString_Z7D8EB286, OntologyAnnotation__get_NameText } from "../JsonTypes/OntologyAnnotation.js";
import { int32 } from "../../../fable_modules/fable-library-ts/Int32.js";
import { ProtocolParameter, ProtocolParameter_create_2769312B } from "../JsonTypes/ProtocolParameter.js";
import { Factor, Factor_create_Z3D2B374F } from "../JsonTypes/Factor.js";
import { MaterialAttribute, MaterialAttribute_create_2769312B } from "../JsonTypes/MaterialAttribute.js";
import { Component, Component_create_Z33AADEE0 } from "../JsonTypes/Component.js";
...
export class CompositeHeader<Tag extends keyof CompositeHeader_$cases> extends Union<Tag, CompositeHeader_$cases[Tag][0]> {
    ...
    toString(): string {
        ...
        switch (this$.tag) {
            case /* Factor */ 2:
                return `Factor [${OntologyAnnotation__get_NameText(this$.fields[0])}]`;
            case /* Characteristic */ 1:
                return `Characteristic [${OntologyAnnotation__get_NameText(this$.fields[0])}]`;
            case /* Component */ 0:
                return `Component [${OntologyAnnotation__get_NameText(this$.fields[0])}]`;
            case /* ProtocolType */ 4:
            ...
            default:
                return `Parameter [${OntologyAnnotation__get_NameText(this$.fields[0])}]`;
        }
    }
    ToTerm(): OntologyAnnotation {
        ...
        switch (this$.tag) {
            ...
            case /* Component */ 0:
                return this$.fields[0];
            case /* ProtocolType */ 4:
                return OntologyAnnotation_fromString_Z7D8EB286("Protocol Type");
            case /* ProtocolREF */ 8:
                return OntologyAnnotation_fromString_Z7D8EB286("Protocol REF");
            case /* ProtocolDescription */ 5:
                return OntologyAnnotation_fromString_Z7D8EB286("Protocol Description");
            case /* ProtocolUri */ 6:
                return OntologyAnnotation_fromString_Z7D8EB286("Protocol Uri");
            case /* ProtocolVersion */ 7:
                return OntologyAnnotation_fromString_Z7D8EB286("Protocol Version");
            case /* Performer */ 9:
                return OntologyAnnotation_fromString_Z7D8EB286("Performer");
            case /* Date */ 10:
                return OntologyAnnotation_fromString_Z7D8EB286("Date");
            case /* Input */ 11: {
                const io: IOType_$union = this$.fields[0];
                return OntologyAnnotation_fromString_Z7D8EB286(io.asInput);
            }
            case /* Output */ 12: {
                const io_1: IOType_$union = this$.fields[0];
                return OntologyAnnotation_fromString_Z7D8EB286(io_1.asOutput);
            }
            case /* FreeText */ 13:
                return OntologyAnnotation_fromString_Z7D8EB286(this$.fields[0]);
            default:
                return this$.fields[0];
        }
    }
                ...
                if (activePatternResult_2 != null) {
                    ...
                    switch (matchValue_1) {
                        ...
                        case "Parameter Value":
                            return CompositeHeader_Parameter(OntologyAnnotation_fromString_Z7D8EB286(r_2.TermName));
                        case "Factor":
                        case "Factor Value":
                            return CompositeHeader_Factor(OntologyAnnotation_fromString_Z7D8EB286(r_2.TermName));
                        case "Characteristic":
                        case "Characteristics":
                        case "Characteristics Value":
                            return CompositeHeader_Characteristic(OntologyAnnotation_fromString_Z7D8EB286(r_2.TermName));
                        case "Component":
                            return CompositeHeader_Component(OntologyAnnotation_fromString_Z7D8EB286(r_2.TermName));
                        default:
    ...
    TryParameter(): Option<ProtocolParameter> {
        const this$ = this as CompositeHeader_$union;
        return (this$.tag === /* Parameter */ 3) ? ProtocolParameter_create_2769312B(void 0, this$.fields[0]) : void 0;
    }
    TryFactor(): Option<Factor> {
        const this$ = this as CompositeHeader_$union;
        return (this$.tag === /* Factor */ 2) ? Factor_create_Z3D2B374F(void 0, void 0, this$.fields[0]) : void 0;
    }
    TryCharacteristic(): Option<MaterialAttribute> {
        const this$ = this as CompositeHeader_$union;
        return (this$.tag === /* Characteristic */ 1) ? MaterialAttribute_create_2769312B(void 0, this$.fields[0]) : void 0;
    }
    TryComponent(): Option<Component> {
        const this$ = this as CompositeHeader_$union;
        return (this$.tag === /* Component */ 0) ? Component_create_Z33AADEE0(void 0, void 0, void 0, this$.fields[0]) : void 0;
    }
}
