...
export function ArcTables_$ctor_Z68BECB99(thisTables: ArcTable[]): ArcTables {
...
export function ArcTables__AddTable_16F700A1(this$: ArcTables, table: ArcTable, index: Option<int32>): void {
...
export function ArcTables__AddTables_3601F24E(this$: ArcTables, tables: Iterable<ArcTable>, index: Option<int32>): void {
    const index_1: int32 = defaultArg<int32>(index, ArcTables__get_Count(this$)) | 0;
    ArcTablesAux_SanityChecks_validateSheetIndex(index_1, true, this$.thisTables);
...
export function ArcTables__InitTable_3B406CA4(this$: ArcTables, tableName: string, index: Option<int32>): void {
    const index_1: int32 = defaultArg<int32>(index, ArcTables__get_Count(this$)) | 0;
...
export function ArcTables__UpdateTableAt_66578202(this$: ArcTables, index: int32, table: ArcTable): void {
    ArcTablesAux_SanityChecks_validateSheetIndex(index, false, this$.thisTables);
    ArcTablesAux_SanityChecks_validateNewNameUnique(table.Name, ArcTables__get_TableNames(this$));
    this$.thisTables[index] = table;
}

export function ArcTables__UpdateTable_4976F045(this$: ArcTables, name: string, table: ArcTable): void {
...
export function ArcTables__MapTableAt_61602D68(this$: ArcTables, index: int32, updateFun: ((arg0: ArcTable) => void)): void {
    ArcTablesAux_SanityChecks_validateSheetIndex(index, false, this$.thisTables);
    updateFun(this$.thisTables[index]);
}

export function ArcTables__MapTable_4E415F2F(this$: ArcTables, name: string, updateFun: ((arg0: ArcTable) => void)): void {
...
export function ArcTables__AddColumnAt_6647579B(this$: ArcTables, tableIndex: int32, header: CompositeHeader_$union, cells: Option<CompositeCell_$union[]>, columnIndex: Option<int32>, forceReplace: Option<boolean>): void {
    ArcTables__MapTableAt_61602D68(this$, tableIndex, (table: ArcTable): void => {
        table.AddColumn(header, unwrap(cells), unwrap(columnIndex), unwrap(forceReplace));
    });
}

export function ArcTables__AddColumn_Z4FC90944(this$: ArcTables, tableName: string, header: CompositeHeader_$union, cells: Option<CompositeCell_$union[]>, columnIndex: Option<int32>, forceReplace: Option<boolean>): void {
...
export function ArcTables__UpdateColumnAt_Z155350AF(this$: ArcTables, tableIndex: int32, columnIndex: int32, header: CompositeHeader_$union, cells: Option<CompositeCell_$union[]>): void {
    ArcTables__MapTableAt_61602D68(this$, tableIndex, (table: ArcTable): void => {
        table.UpdateColumn(columnIndex, header, unwrap(cells));
    });
}

export function ArcTables__UpdateColumn_Z774BF72A(this$: ArcTables, tableName: string, columnIndex: int32, header: CompositeHeader_$union, cells: Option<CompositeCell_$union[]>): void {
...
export function ArcTables__AddRowAt_Z57F91678(this$: ArcTables, tableIndex: int32, cells: Option<CompositeCell_$union[]>, rowIndex: Option<int32>): void {
    ArcTables__MapTableAt_61602D68(this$, tableIndex, (table: ArcTable): void => {
        table.AddRow(unwrap(cells), unwrap(rowIndex));
    });
}

export function ArcTables__AddRow_1177C4AF(this$: ArcTables, tableName: string, cells: Option<CompositeCell_$union[]>, rowIndex: Option<int32>): void {
...
export function ArcTables__UpdateRowAt_Z596C2D98(this$: ArcTables, tableIndex: int32, rowIndex: int32, cells: CompositeCell_$union[]): void {
    ArcTables__MapTableAt_61602D68(this$, tableIndex, (table: ArcTable): void => {
        table.UpdateRow(rowIndex, cells);
    });
}

export function ArcTables__UpdateRow_Z5E65B4B1(this$: ArcTables, tableName: string, rowIndex: int32, cells: CompositeCell_$union[]): void {
 ...
 */
export function ArcTables_fromProcesses_Z31821267(ps: FSharpList<Process>): ArcTables {
    let arg: FSharpList<ArcTable>;
    return ArcTables_$ctor_Z68BECB99((arg = map_1<[string, FSharpList<Process>], ArcTable>((tupledArg: [string, FSharpList<Process>]): ArcTable => {
