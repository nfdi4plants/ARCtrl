...
import { DataType_String, DataType_$union, FsCell } from "../../fable_modules/FsSpreadsheet.3.1.1/Cells/FsCell.fs.js";
...
import { RowBuilder } from "../../fable_modules/FsSpreadsheet.3.1.1/DSL/RowBuilder.fs.js";
import { RowElement_IndexedCell, ColumnIndex, RowElement_UnindexedCell, Message_$union, RowElement_$union, SheetEntity$1_$union } from "../../fable_modules/FsSpreadsheet.3.1.1/DSL/Types.fs.js";
import { map as map_2, initialize as initialize_1, exists, find, cons, append, empty, singleton, FSharpList } from "../../fable_modules/fable-library-ts/List.js";
...
import { Comment$, Comment_create_250E0578, Remark, Remark_make } from "../ISA/JsonTypes/Comment.js";
...
export function SparseTable_ToRows_584133C0(matrix: SparseTable, prefix?: string): Iterable<Iterable<[int32, string]>> {
    const prefix_1: string = (prefix == null) ? "" : (value(prefix) + " ");
...
export function SparseTable_GetEmptyComments_Z15A4F148(matrix: SparseTable): FSharpList<Comment$> {
    return map_2<string, Comment$>((key: string): Comment$ => Comment_create_250E0578(void 0, key), matrix.CommentKeys);
}
