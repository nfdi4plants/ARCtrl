...
import { OntologyAnnotation__get_TermAccessionOntobeeUrl, OntologyAnnotation__get_TermSourceREFString, OntologyAnnotation__get_NameText, OntologyAnnotation } from "../ISA/JsonTypes/OntologyAnnotation.js";
    ...
    switch (cell.tag) {
        case /* Term */ 0:
            if ((v = cell.fields[0], hasUnit)) {
                ...
                return ofArray([new FsCell(OntologyAnnotation__get_NameText(v_6)), new FsCell(""), new FsCell(OntologyAnnotation__get_TermSourceREFString(v_6)), new FsCell(OntologyAnnotation__get_TermAccessionOntobeeUrl(v_6))]);
            }
            else {
                const v_7: OntologyAnnotation = cell.fields[0];
                return ofArray([new FsCell(OntologyAnnotation__get_NameText(v_7)), new FsCell(OntologyAnnotation__get_TermSourceREFString(v_7)), new FsCell(OntologyAnnotation__get_TermAccessionOntobeeUrl(v_7))]);
            }
        case /* Unitized */ 2: {
            const unit: OntologyAnnotation = cell.fields[1];
            const v_8: string = cell.fields[0];
            return ofArray([new FsCell(v_8), new FsCell(OntologyAnnotation__get_NameText(unit)), new FsCell(OntologyAnnotation__get_TermSourceREFString(unit)), new FsCell(OntologyAnnotation__get_TermAccessionOntobeeUrl(unit))]);
        }
        default:
