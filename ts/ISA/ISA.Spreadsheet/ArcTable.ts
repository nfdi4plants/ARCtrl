...
import { FsTable } from "../../fable_modules/FsSpreadsheet.3.1.1/Tables/FsTable.fs.js";
...
import { comparePrimitives } from "../../fable_modules/fable-library-ts/Util.js";
import { FsRangeAddress_$ctor_7E77A4A0 } from "../../fable_modules/FsSpreadsheet.3.1.1/Ranges/FsRangeAddress.fs.js";
import { FsAddress, FsAddress_$ctor_Z37302880 } from "../../fable_modules/FsSpreadsheet.3.1.1/FsAddress.fs.js";
...
export function tryFromFsWorksheet(sheet: FsWorksheet): Option<ArcTable> {
    ...
    if (matchValue == null) {
        ...
        const t: FsTable = value(matchValue);
...
export function toFsWorksheet(table: ArcTable): FsWorksheet {
    ...
    iterateIndexed<FSharpList<FsCell>>((colI: int32, col: FSharpList<FsCell>): void => {
        iterateIndexed<FsCell>((rowI: int32, cell: FsCell): void => {
            ...
            FsRangeBase__Cell_Z3407A44B(fsTable, address, ws.CellCollection).SetValueAs<any>(cell.Value);
        }, col);
    }, columns);
    return ws;
}
