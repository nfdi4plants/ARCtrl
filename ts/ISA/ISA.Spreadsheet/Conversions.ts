...
import { fill, map3, fold } from "../../fable_modules/fable-library-ts/Array.js";
import { toText, printf, toFail } from "../../fable_modules/fable-library-ts/String.js";
import { int32 } from "../../fable_modules/fable-library-ts/Int32.js";
import { OntologyAnnotation_toString_473B9D79, OntologyAnnotation_fromString_Z7D8EB286, OntologyAnnotation } from "../ISA/JsonTypes/OntologyAnnotation.js";
import { map, fold as fold_1, FSharpList, ofArray, empty } from "../../fable_modules/fable-library-ts/List.js";
import { Component_toString_Z7E9B32A1, Component_fromString_55205B02, Component } from "../ISA/JsonTypes/Component.js";
import { Array_map4 } from "./CollectionAux.js";
import { ProtocolParameter_toString_2762A46F, ProtocolParameter, ProtocolParameter_make } from "../ISA/JsonTypes/ProtocolParameter.js";
 ...
 */
export function OntologyAnnotation_fromAggregatedStrings(separator: string, terms: string, source: string, accessions: string): FSharpList<OntologyAnnotation> {
    ...
    if (l === 0) {
        ...
        return ofArray<OntologyAnnotation>(map3<string, string, string, OntologyAnnotation>(OntologyAnnotation_fromString_Z7D8EB286, (terms === "") ? fill(new Array(l), 0, l, "") : terms.split(separator), (source === "") ? fill(new Array(l), 0, l, "") : source.split(separator), (accessions === "") ? fill(new Array(l), 0, l, "") : accessions.split(separator)));
    }
}
 ...
 */
export function OntologyAnnotation_toAggregatedStrings(separator: string, oas: FSharpList<OntologyAnnotation>): { TermAccessionNumberAgg: string, TermNameAgg: string, TermSourceREFAgg: string } {
    let first = true;
    if (equals(oas, empty<OntologyAnnotation>())) {
        return {
        ...
        }, ["", "", ""] as [string, string, string], map<OntologyAnnotation, { TermAccessionNumber: string, TermName: string, TermSourceREF: string }>(OntologyAnnotation_toString_473B9D79, oas));
        return {
...
export function Component_fromAggregatedStrings(separator: string, names: string, terms: string, source: string, accessions: string): FSharpList<Component> {
    ...
    if (l === 0) {
        ...
        return ofArray<Component>(Array_map4<string, string, string, string, Component>(Component_fromString_55205B02, (names === "") ? fill(new Array(l), 0, l, "") : names.split(separator), (terms === "") ? fill(new Array(l), 0, l, "") : terms.split(separator), (source === "") ? fill(new Array(l), 0, l, "") : source.split(separator), (accessions === "") ? fill(new Array(l), 0, l, "") : accessions.split(separator)));
    }
}
...
export function Component_toAggregatedStrings(separator: string, cs: FSharpList<Component>): { NameAgg: string, TermAccessionNumberAgg: string, TermNameAgg: string, TermSourceREFAgg: string } {
    ...
    if (equals(cs, empty<Component>())) {
        ...
        }, ["", "", "", ""] as [string, string, string, string], map<Component, [string, { TermAccessionNumber: string, TermName: string, TermSourceREF: string }]>(Component_toString_Z7E9B32A1, cs));
        return {
 ...
 */
export function ProtocolParameter_fromAggregatedStrings(separator: string, terms: string, source: string, accessions: string): FSharpList<ProtocolParameter> {
...
export function ProtocolParameter_toAggregatedStrings(separator: string, oas: FSharpList<ProtocolParameter>): { TermAccessionNumberAgg: string, TermNameAgg: string, TermSourceREFAgg: string } {
    ...
    if (equals(oas, empty<ProtocolParameter>())) {
        ...
        }, ["", "", ""] as [string, string, string], map<ProtocolParameter, { TermAccessionNumber: string, TermName: string, TermSourceREF: string }>(ProtocolParameter_toString_2762A46F, oas));
        return {
            TermAccessionNumberAgg: tupledArg_1[2],
            TermNameAgg: tupledArg_1[0],
            TermSourceREFAgg: tupledArg_1[1],
