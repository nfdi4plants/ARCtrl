...
import { ofSeq, append, reverse, cons, iterate, isEmpty, empty, map, ofArray, FSharpList } from "../../../fable_modules/fable-library-ts/List.js";
...
import { SparseRowModule_fromValues, SparseTable_ToRows_584133C0, SparseTable_FromRows_Z5579EC29, SparseTable_Create_Z2192E64B, SparseTable, SparseTable__TryGetValueDefault_5BAE6133 } from "../SparseTable.js";
...
export function StudyInfo_$reflection(): TypeInfo {
    return record_type("ISA.Spreadsheet.Studies.StudyInfo", [], StudyInfo, () => [["Identifier", string_type], ["Title", string_type], ["Description", string_type], ["SubmissionDate", string_type], ["PublicReleaseDate", string_type], ["FileName", string_type], ["Comments", list_type(Comment$_$reflection())]]);
}
...
export function StudyInfo_FromSparseTable_Z15A4F148(matrix: SparseTable): StudyInfo {
...
export function StudyInfo_ToSparseTable_331096F(study: ArcStudy): SparseTable {
...
export function StudyInfo_fromRows(lineNumber: int32, rows: IEnumerator<Iterable<[int32, string]>>): [Option<string>, int32, FSharpList<Remark>, StudyInfo] {
    ...
    return [tupledArg[0], tupledArg[1], tupledArg[2], StudyInfo_FromSparseTable_Z15A4F148(tupledArg[3])] as [Option<string>, int32, FSharpList<Remark>, StudyInfo];
}

export function StudyInfo_toRows_331096F(study: ArcStudy): Iterable<Iterable<[int32, string]>> {
    return SparseTable_ToRows_584133C0(StudyInfo_ToSparseTable_331096F(study));
}
...
export function fromParts(studyInfo: StudyInfo, designDescriptors: FSharpList<OntologyAnnotation>, publications: FSharpList<Publication>, factors: FSharpList<Factor>, assays: FSharpList<ArcAssay>, protocols: FSharpList<Protocol>, contacts: FSharpList<Person>): Option<ArcStudy> {
    ...
    arcstudy = ArcStudy.make(studyInfo.Identifier, arg_1, arg_2, arg_3, arg_4, publications, contacts, designDescriptors, arg_8, arg_9, factors, studyInfo.Comments);
...
export function toRows(study: ArcStudy): Iterable<Iterable<[int32, string]>> {
    ...
    return delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(StudyInfo_toRows_331096F(study), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY DESIGN DESCRIPTORS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_1("Study Design", study.StudyDesignDescriptors), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY PUBLICATIONS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_2("Study Publication", study.Publications), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY FACTORS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_3("Study Factor", study.Factors), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY ASSAYS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_4("Study Assay", ofSeq<ArcAssay>(study.Assays)), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY PROTOCOLS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(toRows_5("Study Protocol", protocols), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => append_1<Iterable<[int32, string]>>(singleton<Iterable<[int32, string]>>(SparseRowModule_fromValues(["STUDY CONTACTS"])), delay<Iterable<[int32, string]>>((): Iterable<Iterable<[int32, string]>> => toRows_6("Study Person", study.Contacts))))))))))))))))))))))))));
}
