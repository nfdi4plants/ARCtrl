...
import { IOptionalGetter, IGetters, list as list_1, string, object as object_13 } from "../../fable_modules/Thoth.Json.10.1.0/Decode.fs.js";
...
export function decoder(options: ConverterOptions): ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<Publication, [string, ErrorReason_$union]>)) {
    return (path_4: string): ((arg0: any) => FSharpResult$2_$union<Publication, [string, ErrorReason_$union]>) => ((v: any): FSharpResult$2_$union<Publication, [string, ErrorReason_$union]> => object_13<Publication>((get$: IGetters): Publication => {
        let objectArg: IOptionalGetter, objectArg_1: IOptionalGetter, objectArg_2: IOptionalGetter, objectArg_3: IOptionalGetter, arg_9: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<OntologyAnnotation, [string, ErrorReason_$union]>)), objectArg_4: IOptionalGetter, arg_11: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]>)), decoder_1: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<Comment$, [string, ErrorReason_$union]>)), objectArg_5: IOptionalGetter;
        return new Publication((objectArg = get$.Optional, objectArg.Field<string>("pubMedID", uri)), (objectArg_1 = get$.Optional, objectArg_1.Field<string>("doi", string)), (objectArg_2 = get$.Optional, objectArg_2.Field<string>("authorList", string)), (objectArg_3 = get$.Optional, objectArg_3.Field<string>("title", string)), (arg_9 = OntologyAnnotation_decoder(options), (objectArg_4 = get$.Optional, objectArg_4.Field<OntologyAnnotation>("status", uncurry2(arg_9)))), (arg_11 = ((decoder_1 = decoder_2(options), (path_3: string): ((arg0: any) => FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]>) => ((value_3: any): FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]> => list_1<Comment$>(uncurry2(decoder_1), path_3, value_3)))), (objectArg_5 = get$.Optional, objectArg_5.Field<FSharpList<Comment$>>("comments", uncurry2(arg_11)))));
    }, path_4, v));
}
