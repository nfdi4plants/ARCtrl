...
import { IOptionalGetter, IGetters, list as list_1, object as object_11, string, float, int } from "../../fable_modules/Thoth.Json.10.1.0/Decode.fs.js";
...
export function OntologySourceReference_decoder(options: ConverterOptions): ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<OntologySourceReference, [string, ErrorReason_$union]>)) {
    return (path_4: string): ((arg0: any) => FSharpResult$2_$union<OntologySourceReference, [string, ErrorReason_$union]>) => ((v: any): FSharpResult$2_$union<OntologySourceReference, [string, ErrorReason_$union]> => object_11<OntologySourceReference>((get$: IGetters): OntologySourceReference => {
        let objectArg: IOptionalGetter, objectArg_1: IOptionalGetter, objectArg_2: IOptionalGetter, objectArg_3: IOptionalGetter, arg_9: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]>)), decoder: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<Comment$, [string, ErrorReason_$union]>)), objectArg_4: IOptionalGetter;
        return new OntologySourceReference((objectArg = get$.Optional, objectArg.Field<string>("description", uri)), (objectArg_1 = get$.Optional, objectArg_1.Field<string>("file", string)), (objectArg_2 = get$.Optional, objectArg_2.Field<string>("name", string)), (objectArg_3 = get$.Optional, objectArg_3.Field<string>("version", string)), (arg_9 = ((decoder = decoder_1(options), (path_3: string): ((arg0: any) => FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]>) => ((value_3: any): FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]> => list_1<Comment$>(uncurry2(decoder), path_3, value_3)))), (objectArg_4 = get$.Optional, objectArg_4.Field<FSharpList<Comment$>>("comments", uncurry2(arg_9)))));
    }, path_4, v));
}
...
export function OntologyAnnotation_decoder(options: ConverterOptions): ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<OntologyAnnotation, [string, ErrorReason_$union]>)) {
    return (path_3: string): ((arg0: any) => FSharpResult$2_$union<OntologyAnnotation, [string, ErrorReason_$union]>) => ((v: any): FSharpResult$2_$union<OntologyAnnotation, [string, ErrorReason_$union]> => object_11<OntologyAnnotation>((get$: IGetters): OntologyAnnotation => {
        let objectArg: IOptionalGetter, objectArg_1: IOptionalGetter, objectArg_2: IOptionalGetter, objectArg_3: IOptionalGetter, objectArg_4: IOptionalGetter, arg_11: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]>)), decoder: ((arg0: string) => ((arg0: any) => FSharpResult$2_$union<Comment$, [string, ErrorReason_$union]>)), objectArg_5: IOptionalGetter;
        ...
        }, (objectArg_3 = get$.Optional, objectArg_3.Field<string>("termAccession", OntologyAnnotation_localIDDecoder))), (objectArg_4 = get$.Optional, objectArg_4.Field<string>("termAccession", string)), (arg_11 = ((decoder = decoder_1(options), (path_2: string): ((arg0: any) => FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]>) => ((value_2: any): FSharpResult$2_$union<FSharpList<Comment$>, [string, ErrorReason_$union]> => list_1<Comment$>(uncurry2(decoder), path_2, value_2)))), (objectArg_5 = get$.Optional, objectArg_5.Field<FSharpList<Comment$>>("comments", uncurry2(arg_11)))));
    }, path_3, v));
}
