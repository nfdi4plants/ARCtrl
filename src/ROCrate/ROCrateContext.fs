...
module Context =
    ...
    [<Literal>]
    let proxy_V1_1 = "https://w3id.org/ro/crate/1.1/context"

    [<Literal>]
    let proxy_V1_2DRAFT = "https://w3id.org/ro/crate/1.2-DRAFT/context"

    let initV1_1 () =
        let c = LDContext.fromMappingSeq termsV1_1
        c.Name <- Some proxy_V1_1
        c

    let initV1_2DRAFT () =
        let c = LDContext.fromMappingSeq termsV1_2DRAFT
        c.Name <- Some proxy_V1_2DRAFT
        c